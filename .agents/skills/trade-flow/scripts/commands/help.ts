export const HELP_TEXT = `Usage:
  ...
  ./scripts/main.ts --rd-program-state --state ./state/rd/program.json --json '{"action":"init","objective":"find a shadow-eligible 4H swing strategy"}'
  ./scripts/main.ts --rd-program-state --state ./state/rd/program.json --json '{"action":"plan_next"}'
  ./scripts/main.ts --rd-supervisor-run --state ./state/rd/program.json --json '{"max_iterations":10,"artifact_root":"./tmp/artifacts/strategy-rnd"}'
