...
test("R&D families are discovered from family modules", () => {
  assert.deepEqual(listRndFamilyIds(), ["relative_weakness_momentum_v1", "structure_breakout_retest_v1", "time_series_momentum_v1", "trend_pullback_v1", "volatility_compression_breakout_v1"])
