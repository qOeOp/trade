...
candidate_universe: non-meme liquid USDM alt majors only; exclude meme contracts and symbols with unresolved tail-risk classification.
...
next_required_proof: fresh locked holdout or forward shadow-free replay on unseen candles, then shadow evidence with execution attribution.
```
