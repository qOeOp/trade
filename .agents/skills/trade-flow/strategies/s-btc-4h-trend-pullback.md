...
- 2026-07-07 alternate-family R&D executed `structure_breakout_retest_v1` on BTCUSDT 4H with 8 predeclared variants. Long variants were negative; short variants were positive but had only 9-18 total and 3-6 OOS samples. Artifact: `data/artifacts/strategy-rnd/btc-4h-structure-retest-rnd-2026-07-07-a.json`; `accepted_count=0`, so this remains a research hypothesis rather than strategy evidence.
- 2026-07-07 froze `SBR-S-40-A` and tested it on non-overlapping BTCUSDT 4H history from 2019-09 to 2025-10. Across 92 trades it returned `avgR=-0.150`, `PF=0.780`, `maxDD=15.74R`; its 28-trade OOS slice also stayed negative. Artifact: `data/artifacts/strategy-rnd/btc-4h-structure-retest-short-external-validation-2026-07-07.json`. The candidate is rejected; any rule change is a new hypothesis, not continuation evidence.
- 2026-07-07 bounded campaign tested fixed base trend-pullback long and short hypotheses on 2019-2025 BTCUSDT 4H history. Long: 204 trades, `avgR=-0.005`, OOS `avgR=-0.091`; short: 195 trades, `avgR=-0.055`, OOS `avgR=-0.023`. Both stopped at discovery, so no external validation was spent. Summary: `data/artifacts/strategy-rnd/btc-4h-core-mechanisms-campaign-2026-07-07.campaign.json`.
