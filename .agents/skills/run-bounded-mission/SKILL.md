...
- `invalidated`: evidence shows the objective is wrong or no permitted replan can produce a valid design within the frozen external bounds and remaining budgets;
