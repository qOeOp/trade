...
| `VER` | Verification                  | Independent verification of candidates, instructions, judges, or evidence; evaluator and reviewer integrity; and audit contracts                                          | Evaluator packet/admission; independent Skill evaluation system                                             | Lifecycle aggregation belongs to `QUA`; provider delivery barriers belong to `DLV`                                                                                                                                           | `primary`; evaluator and reviewer support lanes do not create tasks                                                                     |
