...
import { readArtifactHistoricalGatewayV1 } from "@/lib/artifact-readback-gateway";
...
export async function GET(
  ...
  const result = await readArtifactHistoricalGatewayV1({ buildRequestIdentity, attemptIdentity });
