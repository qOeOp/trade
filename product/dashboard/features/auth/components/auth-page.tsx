  ...
  return (
    <main className="relative md:h-screen md:overflow-hidden lg:grid lg:grid-cols-2">
      ...
      <div className="relative flex min-h-screen flex-col justify-center p-4">
        ...
        >
          <div className="-translate-y-87.5 absolute top-0 right-0 h-320 w-140 rounded-full bg-[radial-gradient(68.54%_68.72%_at_55.02%_31.46%,--theme(--color-foreground/.06)_0,--theme(--color-foreground/.02)_50%,--theme(--color-foreground/.01)_80%)]" />
