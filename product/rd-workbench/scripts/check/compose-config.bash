...
POSTGRES_PASSWORD=check-only \
  ...
  MARKET_DATA_READER_DB_PASSWORD=check-only \
  ...
  EXECUTION_WRITER_DB_PASSWORD=check-only \
  PORTFOLIO_WRITER_DB_PASSWORD=check-only \
  GOVERNANCE_WRITER_DB_PASSWORD=check-only \
  INSTRUMENT_OWNER_DB_PASSWORD=check-only \
  RISK_WRITER_DB_PASSWORD=check-only \
  SCANNER_WRITER_DB_PASSWORD=check-only \
