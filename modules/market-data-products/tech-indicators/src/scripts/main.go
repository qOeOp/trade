...
const helpText = `Usage:
  go run ./src/scripts --manifest /tmp/ohlcv/manifest.json
  go run ./src/scripts --manifest /tmp/ohlcv/manifest.json --indicators ema,sma,rsi
...
func defaultCatalogPath() string {
	...
	return filepath.Join("modules", "analytics", "tech-indicators", "src", "scripts", "indicator_catalog.json")
}
