...
function fixture(): ForwardAdmissionRequest {
  ...
  const replayRequest: ReplayExecutionRequest = {
    ...
    dataset_manifest_ref: "dataset://forward", dataset_hash: HASH, venue_risk_policy_snapshot_hash: HASH, instrument_spec_snapshot_hash: HASH, harness_hash: HASH, assumptions_hash: HASH, strategy_policy_hash: HASH,
