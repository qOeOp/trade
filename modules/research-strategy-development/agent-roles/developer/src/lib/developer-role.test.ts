...
test("Developer request copies authority identity without inventing it", () => {
  const request = buildDeveloperReplayRequest({
    ...
    dataset_manifest_ref: "dataset://fixture", dataset_hash: HASH, venue_risk_policy_schedule_hash: HASH, instrument_spec_schedule_hash: HASH, harness_hash: HASH, assumptions_hash: HASH,
