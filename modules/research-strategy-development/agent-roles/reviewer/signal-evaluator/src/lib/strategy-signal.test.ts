...
import {
  buildSyntheticReplayCandles as buildReplayCandles,
  writeSyntheticReplayManifest as writeManifest,
} from "../../../../../replay-execution-plane/compatibility/legacy-research-data/src/lib/synthetic-replay-candles"
