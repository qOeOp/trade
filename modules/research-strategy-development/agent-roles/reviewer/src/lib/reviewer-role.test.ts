...
import { REPLAY_JOURNAL_POLICY_VERSION, REPLAY_NUMERIC_POLICY_VERSION, REPLAY_RESULT_SCHEMA_VERSION, type ReplayResult } from "../../../../replay-execution-plane/contracts/src/lib/replay-contracts"
...
const result: ReplayResult = {
  schema_version: REPLAY_RESULT_SCHEMA_VERSION, run_id: "run-1", status: "completed", started_at: "2026-07-14T04:00:00Z", completed_at: "2026-07-14T08:00:00Z", source_events: [], order_events: [], fills: [], positions: [], ledger: [], journal: [],
  trial_balance: { policy_version: REPLAY_JOURNAL_POLICY_VERSION, settlement_asset: "USDT", debit_total: 0, credit_total: 0, account_balances: [], wallet_cash_balance: 1010, ending_equity: 1010, balanced: true },
  ...
  fingerprint: { experiment_contract_hash: HASH, trial_group_hash: HASH, candidate_hash: HASH, identity_hash_policy_version: "identity-v1", dataset_manifest_hash: HASH, dataset_hash: HASH, harness_hash: HASH, assumptions_hash: HASH, cost_policy_hash: HASH, simulator_policy_version: "sim-v1", numeric_policy_version: REPLAY_NUMERIC_POLICY_VERSION, journal_policy_version: REPLAY_JOURNAL_POLICY_VERSION, request_hash: HASH, result_hash: HASH, random_seed: 1 },
}
