...
import {
  ...
  REPLAY_PORTFOLIO_PROTECTIVE_TAKE_PROFIT_REPLACEMENT_CYCLE_SEQUENCE_ARTIFACT_ROLES,
  assertReplayPortfolioProtectiveTakeProfitReplacementCycleSequenceArtifactManifest,
  type ReplayPortfolioProtectiveTakeProfitReplacementCycleSequenceArtifactManifest,
  type ReplayPortfolioProtectiveTakeProfitReplacementCycleSequenceArtifactRole,
...
const NAMES: Record<ReplayPortfolioProtectiveTakeProfitReplacementCycleSequenceArtifactRole, string> = {
...
export interface ReplayPortfolioProtectiveTakeProfitReplacementCycleSequenceArtifactPublishInput {
  ...
  evidence: ReplayPortfolioProtectiveTakeProfitReplacementCycleSequenceEvidence
  artifact_store: ReplayArtifactStore
}

export function publishReplayPortfolioProtectiveTakeProfitReplacementCycleSequenceArtifact(
  input: ReplayPortfolioProtectiveTakeProfitReplacementCycleSequenceArtifactPublishInput,
): { manifest: ReplayPortfolioProtectiveTakeProfitReplacementCycleSequenceArtifactManifest; idempotent_replay: boolean } {
  return publishReplayPortfolioProtectiveReplacementCycleSequenceArtifact({
    schema_version:
      REPLAY_PORTFOLIO_PROTECTIVE_TAKE_PROFIT_REPLACEMENT_CYCLE_SEQUENCE_ARTIFACT_MANIFEST_SCHEMA_VERSION,
    roles: REPLAY_PORTFOLIO_PROTECTIVE_TAKE_PROFIT_REPLACEMENT_CYCLE_SEQUENCE_ARTIFACT_ROLES,
    names: NAMES,
    manifest_name: "portfolio-protective-take-profit-replacement-cycle-sequence-artifact-manifest.json",
    artifact_id_prefix: "replay-portfolio-protective-take-profit-replacement-cycle-sequence",
    assert_manifest: (value) => assertReplayPortfolioProtectiveTakeProfitReplacementCycleSequenceArtifactManifest(
