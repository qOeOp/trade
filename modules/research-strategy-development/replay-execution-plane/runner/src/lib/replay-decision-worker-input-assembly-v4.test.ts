...
test("Replay binds runtime inputs and deterministic code evidence without Worker authority", async () => {
  ...
  try {
    ...
    expect(successorProcessLaunchIntent.runtime_version)
      .toBe(successorStdioProbeAdmission.successor_stdio_capability.runtime.runtime_version)
    expect(successorProcessLaunchIntent.runtime_executable_hash)
      .toBe(successorStdioProbeAdmission.successor_stdio_capability.runtime.executable_sha256)
