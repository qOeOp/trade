...
runner/     Attempt lease fencing、幂等、transport-neutral cancellation coordinator/local durable outbox/no-replay recovery、typed failure、Harness worker 与完整 Artifact commit
