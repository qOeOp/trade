...
runner/     Attempt lease fencing、幂等、transport-neutral coordinator/pre-terminal local durable outbox/no-replay recovery、typed failure、Harness worker 与完整 Artifact commit
