...
const EXPECTED_PROFILES: Array<Omit<ReplayPublicationCrashRecoveryProfile,
  "writer_source_sha256" | "test_source_sha256">> = [
  {
    ...
    writer_path: "modules/research-strategy-development/replay-execution-plane/runner/src/lib/replay-trial-runner.ts",
    writer_export: "runReplayTrial",
    test_path: "modules/research-strategy-development/replay-execution-plane/runner/src/lib/replay-independent-lane-batch-runner.test.ts",
  ...
  },
  {
    ...
    writer_path: "modules/research-strategy-development/replay-execution-plane/runner/src/lib/replay-integrated-portfolio-artifact-publisher.ts",
  ...
  },
  {
    ...
    writer_path: "modules/research-strategy-development/replay-execution-plane/runner/src/lib/replay-trial-runner.ts",
    writer_export: "runReplayTrial",
    test_path: "modules/research-strategy-development/replay-execution-plane/runner/src/lib/replay-trial-runner.test.ts",
  ...
  },
  {
    ...
    publication_scope: "direct-manifest",
    recovery_mode: "deterministic-full-rerun-no-checkpoint-writer",
    writer_path: "modules/research-strategy-development/replay-execution-plane/runner/src/lib/replay-portfolio-protective-terminal-cycle-sequence-artifact-publisher.ts",
