...
const EXPECTED_SOURCE_IDENTITIES = [
  {
    path: "modules/research-strategy-development/replay-execution-plane/contracts/src/lib/replay-independent-lane-batch-contracts.ts",
    required_fragments: ["export interface ReplayIndependentLaneBatchOutcome", "partial_result_published: false"],
  },
  {
    path: "modules/research-strategy-development/replay-execution-plane/contracts/src/lib/replay-integrated-portfolio-contracts.ts",
    required_fragments: ["export interface ReplayIntegratedPortfolioOutcome", "partial_result_published: false"],
  },
  {
    path: "modules/research-strategy-development/replay-execution-plane/runner/src/lib/replay-trial-runner.ts",
    required_fragments: ["export interface ReplayTrialRunOutcome", "failure_class:", "retryable: boolean", "partial_result_published: false"],
  },
  {
    path: "modules/research-strategy-development/replay-execution-plane/contracts/src/lib/replay-portfolio-protective-terminal-cycle-sequence-contracts.ts",
  ...
  {
    path: "modules/research-strategy-development/replay-execution-plane/certification/replay-certification/src/scripts/main.ts",
