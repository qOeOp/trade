...
- Define the immutable identity binding shared by Trial, Replay, Forward, and Draft Strategy registration, including Trial Reservation v4 bindings for Replay risk/spec schedules and supplemental revision stream.
