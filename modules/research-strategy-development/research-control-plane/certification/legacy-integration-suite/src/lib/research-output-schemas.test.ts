...
import { replayRegisteredStrategy } from "../../../../../replay-execution-plane/compatibility/replay-engine/src/lib/strategy-replay"
...
function readSchema(name: string): JSONRecord {
  ...
  if (name === "strategy-rnd-batch-result") {
    return JSON.parse(readFileSync(new URL("../../../../../agent-roles/developer/candidate-batch/src/schemas/strategy-rnd-batch-result.schema.json", import.meta.url), "utf8")) as JSONRecord
  }
  if (name === "strategy-rnd-loop-result") {
    return JSON.parse(readFileSync(new URL("../../../../../agent-roles/developer/rd-loop-runner/src/schemas/strategy-rnd-loop-result.schema.json", import.meta.url), "utf8")) as JSONRecord
  }
  if (name === "strategy-rnd-campaign-result") {
    return JSON.parse(readFileSync(new URL("../../../../../agent-roles/developer/rd-campaign-runner/src/schemas/strategy-rnd-campaign-result.schema.json", import.meta.url), "utf8")) as JSONRecord
  }
