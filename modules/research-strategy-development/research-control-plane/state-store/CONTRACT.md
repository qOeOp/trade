...
- Accept redelivery from a Runner-owned durable cancellation outbox through the same Observation registry; Control Plane does not read、mutate or garbage-collect the outbox and does not treat its commit as Result、Checkpoint or Resume authority.
