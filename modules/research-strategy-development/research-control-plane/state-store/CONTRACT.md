...
- Atomically materialize immutable Trial Reservation Snapshot v2 from the reserved Trial, Trial Group, Candidate membership and Experiment Contract join; issuance is refused after the Trial leaves `reserved`, and Control Plane supplies an RFC 3339 UTC half-open claim window `[issued_at, expires_at)`.
