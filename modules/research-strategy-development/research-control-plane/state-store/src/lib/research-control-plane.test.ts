  ...
  try {
    ...
    const snapshot = issueTrialReservationSnapshot(db, {
      ...
      bindings: {
        ...
        venue_risk_policy_schedule_hash: "c".repeat(64), instrument_spec_schedule_hash: "d".repeat(64), instrument_status_schedule_hash: "f".repeat(64), harness_hash: "e".repeat(64),
