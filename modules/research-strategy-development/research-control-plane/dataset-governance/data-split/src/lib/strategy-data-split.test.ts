...
test("strategy data split output schema matches stable report shell", () => {
  ...
  try {
    ...
    const schema = readJsonFile("modules/research-strategy-development/research-control-plane/dataset-governance/data-split/src/schemas/strategy-data-split-result.schema.json")
