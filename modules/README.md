...
| `research-strategy-development/replay-execution-plane/certification/legacy-portfolio-cycle-certification` | frozen P10/P11 Trial/reservation/lifecycle fixture | reallocation → two-cycle Result/Artifact regression | 历史 portfolio-cycle consumer 独立认证 | runtime、CLI、生产语义、P13 accounting authority |
