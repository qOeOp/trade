...
| `research-strategy-development/replay-execution-plane/compatibility/legacy-research-kernel` | 既有 manifest、candidate、family 与 forward inputs | legacy evaluation/result、data/hash helpers | 有界维持迁移期 R&D/Forward 消费者 | native Trial Replay、Result/Artifact authority、新调用方 |
