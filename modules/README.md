...
| `research-strategy-development/replay-execution-plane/certification/legacy-replay-fingerprint` | legacy replay manifest / assumptions | evidence fingerprint certification | 基于旧 Replay kernel 的 evidence parity 认证 | replay 执行、Trial 转发、新语义 owner、策略升格 |
