...
| `research-strategy-development/replay-execution-plane/compatibility/legacy-replay-fingerprint` | legacy replay manifest / assumptions | evidence fingerprint | 旧 replay evidence 完整性复核 | replay 执行、Trial 转发、新语义 owner、策略升格 |
