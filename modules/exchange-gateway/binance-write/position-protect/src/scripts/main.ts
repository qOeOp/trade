...
const HELP_TEXT = `Usage:
  bun src/scripts/main.ts --symbol BTCUSDT --position-side LONG --quantity 0.01 --stop-loss-trigger 64000 --take-profit-trigger 68000 --yes
  bun src/scripts/main.ts --symbol ETHUSDT --position-side LONG --quantity 1.25 --stop-loss-trigger 2368 --yes
