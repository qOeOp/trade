...
export function loadRuntimePolicyFromOwner(input: { accountConfigPath: string }): JSONRecord {
  return runRuntimePolicyCompilerSync(["--account-config", input.accountConfigPath])
}
