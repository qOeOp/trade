...
} from "./ohlcv-coverage-contract"

export function buildOhlcvCoverageAuditFixture(
  ...
  const withoutHash = {
    ...
    actual_count: complete ? expectedCount : 0,
    missing_count: complete ? 0 : expectedCount,
    gap_range_count: complete ? 0 : 1,
    ...
    first_open_time: complete ? target.start_open_time : null,
    last_open_time: complete ? target.end_open_time : null,
    complete,
