...
readonly -A unselected_reason=(
  ...
  ["composer_unlogged_drift_is_unavailable_to_migration_and_runtime"]="needs sealed-source-intake-composer-acceptance; the chain's archive does not enable it, and enabling it first needs the thirteen clippy refusals that feature still carries cleared"
  ...
  ["forged_v3_admission_fails_without_replay_transition_or_outbox_write"]="needs sealed-source-intake-composer-acceptance; the chain's archive does not enable it, and enabling it first needs the thirteen clippy refusals that feature still carries cleared"
  ...
  ["postgres_every_transaction_write_boundary_fault_leaves_zero_positive_rows"]="needs sealed-source-intake-composer-acceptance; the chain's archive does not enable it, and enabling it first needs the thirteen clippy refusals that feature still carries cleared"
  ...
  ["sealed_run_and_restarted_resolve_return_the_same_public_receipt"]="needs sealed-source-intake-composer-acceptance; the chain's archive does not enable it, and enabling it first needs the thirteen clippy refusals that feature still carries cleared"
