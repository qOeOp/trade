...
| `modules/research-strategy-development/replay-execution-plane/compatibility/legacy-research-kernel/` | legacy research compatibility | 维持既有 R&D/Forward 的候选评估与 legacy result 语义 | native Trial Replay、Result/Artifact authority、新调用方 |
