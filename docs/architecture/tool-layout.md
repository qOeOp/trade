...
| `modules/research-strategy-development/replay-execution-plane/certification/legacy-portfolio-cycle-certification/` | portfolio-cycle compatibility certification | P10 reallocation → P11 two-cycle 的完整 Result/Artifact、幂等与拒绝回归链 | runtime/CLI、生产语义、P12+ successor、P13 accounting authority |
