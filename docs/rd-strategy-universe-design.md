---
title: RD Strategy Universe Design
...
本文是 RD 策略宇宙、研究流程、agent 入口纪律、coverage/backlog 语义的唯一 Markdown 设计文档。`docs/strategy-universe-family-backlog.json` 和 `docs/strategy-universe-p0-family-certificates.json` 是机器可读派生资产，不再另设 taxonomy / designer Markdown。
