---
title: Legacy R&D Event Chain Design
...
# Legacy R&D Event Chain Design

> 本文保留早期 paper / shadow tracker 事件模型和落地顺序，不再定义整个 R&D lifecycle。当前边界见 [R&D Event Contract](../research/architecture/rd-event-chain-design.md)。
