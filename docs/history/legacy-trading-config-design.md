---
title: Legacy Trading Config Design
...
# Legacy Trading Config Design

> 本文保留 runtime policy compiler 落地前后的混合设计记录，不再描述当前完成度。当前合同见 [Trading Config](../runtime/trading-config.md) 与 [Risk Control Contract](../runtime/risk-control-contract.md)。
