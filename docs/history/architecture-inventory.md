...
> 这是 2026-07-08 的基线快照，不是当前模块清单。当前事实看 [architecture-manifest.json](../architecture/architecture-manifest.json) 与 [architecture-drift-report.md](../architecture/generated/architecture-drift-report.md)。
...
项目级“改了哪里跑什么”见 [check-contract.md](../engineering/check-contract.md)。本节只保留 P0 盘点时的粗入口。
