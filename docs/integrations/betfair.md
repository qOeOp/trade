...
- [Python examples](https://github.com/qOeOp/trade/tree/main/examples/live/betfair/)
- [Rust examples](https://github.com/qOeOp/trade/tree/main/crates/adapters/betfair/examples/)
...
first-seen snapshot seeds its cumulative void state without reversing exposure Vibe never
