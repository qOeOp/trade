...
| `legacy-replay-fingerprint-check` | `modules/research-strategy-development/replay-execution-plane/compatibility/legacy-replay-fingerprint` | `bun run check` | legacy replay evidence fingerprint parity |
...
| legacy replay fingerprint | `modules/research-strategy-development/replay-execution-plane/compatibility/legacy-replay-fingerprint/src/**`, `modules/research-strategy-development/replay-execution-plane/compatibility/replay-engine/src/**` | `legacy-replay-fingerprint-check` + `strategy-review-check`; add `rd-integration-suite-check` if shared replay semantics changed |
