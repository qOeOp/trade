...
| `doc-contract-check` | repo root | `bun scripts/check-doc-contracts.ts` | 文档元数据、受控 status、可解析 owner、当前 contract index、历史状态、Markdown 相对路径、risk contract 与实际 Guard ID 对齐；不验证外部 URL 或页面 anchor |
