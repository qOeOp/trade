...
| `legacy-portfolio-cycle-certification-check` | `modules/research-strategy-development/replay-execution-plane/certification/legacy-portfolio-cycle-certification` | `bun run check` | P10 reallocation → P11 two-cycle Result/Artifact、idempotence and rejection certification |
