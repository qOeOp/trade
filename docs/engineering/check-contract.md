...
| legacy replay fingerprint certification | `modules/research-strategy-development/replay-execution-plane/certification/legacy-replay-fingerprint/src/**`, `modules/research-strategy-development/replay-execution-plane/compatibility/replay-engine/src/**` | `legacy-replay-fingerprint-certification-check` + `strategy-review-check`; add `rd-integration-suite-check` if shared replay semantics changed |
