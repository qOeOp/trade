...
| `market_data_store` | implemented | `market-data-products/market-data-store` | `data/market_data.db` | market/funding/feature manifests；instrument-status Archive v2、source-batch/audit 与 append-only supersession；不证明外部源穷尽 |
