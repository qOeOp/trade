...
| -------------------------------------------- | --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| S1 V2 TrialFamily -> S2 Artifact binding     | `ACTIVE / OBSERVED_CANDIDATE_NOT_CURRENT`                 | 被拒绝 candidate `222c7a669a` 动态证明隔离 canonical‑history 链路 `basis receipt -> Qualification GENESIS_EMPTY receipt -> S1 ACCEPTED/family census -> S2 SUCCESS/time-bound binding receipt -> REVIEW_ARTIFACT`；restart 加 page/job cache loss 在不重新执行 S2 时返回 byte‑identical request、attempt、basis、Qualification frontier、family、Artifact 与 binding identity。在不变原历史上，Windmill job `success` 仍是业务 `SUBMITTED_OR_UNKNOWN`，且只有 `RESOLVE_SAME_REQUEST_IDENTITY`，证明 operational success 与 Owner outcome 必须分离 |
