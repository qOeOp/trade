...
D  [Lease] WorkerLeaseCard: identity, host, lease liveness, heartbeat age, limits, last run
   [Capabilities] WorkerCapabilityMatrix: registered kind/tag/runtime/isolation; no unbound run readiness
