...
| --------------------------------------------- | --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| S1 V2 TrialFamily -> S2 Artifact binding      | `ACTIVE / OBSERVED_CANDIDATE_NOT_CURRENT`                 | Rejected candidate `222c7a669a` dynamically proved the isolated canonical‑history chain `basis receipt -> Qualification GENESIS_EMPTY receipt -> S1 ACCEPTED/family census -> S2 SUCCESS/time-bound binding receipt -> REVIEW_ARTIFACT`; restart plus page/job cache loss returned byte‑identical request, attempt, basis, Qualification frontier, family, Artifact and binding identities without rerunning S2. Against unchanged original history, Windmill job `success` remained business `SUBMITTED_OR_UNKNOWN` with only `RESOLVE_SAME_REQUEST_IDENTITY`, proving operational success and Owner outcome must stay separate                             |
