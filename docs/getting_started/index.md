...
Set up a Python 3.12-3.14 environment and build the package from the repository root:

```bash
make build-debug
```

See the [Installation](installation) guide for prerequisites and source-build options.
