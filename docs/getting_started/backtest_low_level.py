...
#
# [View source on GitHub](https://github.com/qOeOp/trade/blob/main/docs/getting_started/backtest_low_level.py).
...
# instrument, and wrangle the raw CSV into Vibe `TradeTick` objects.
...
# %% [markdown]
# See the [Data](../concepts/data/index.md) concept guide for details on the data processing pipeline.
