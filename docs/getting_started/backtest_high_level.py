...
#
# [View source on GitHub](https://github.com/qOeOp/trade/blob/main/docs/getting_started/backtest_high_level.py).
...
# `VIBE_DATA_DIR` environment variable to the parent directory containing a
# `HISTDATA` subfolder).
...
# raw data into a DataFrame, then process it into Vibe `QuoteTick` objects
