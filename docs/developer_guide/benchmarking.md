...
| Goal                               | Command                                                               |
| ---------------------------------- | --------------------------------------------------------------------- |
| All benches in one crate           | `cargo bench -p vibe-execution`                                   |
| One core bench module              | `cargo bench -p vibe-execution --bench matching_core`             |
| One engine bench module            | `cargo bench -p vibe-execution --bench matching_engine`           |
| One core benchmark name pattern    | `cargo bench -p vibe-execution --bench matching_core -- iterate`  |
| One engine benchmark name pattern  | `cargo bench -p vibe-execution --bench matching_engine -- submit` |
