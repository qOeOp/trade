...
Vibe instrument with the synthetic venue code `SYNTH`.
...
as analytical tools. In the future, Vibe may support trading component instruments based
on synthetic instrument behavior.

## Formula language

Each synthetic instrument defines a derivation formula. Vibe evaluates this formula with
...
Vibe validates synthetic instruments at every boundary. Formula compilation rejects
...
See the
[`SyntheticInstrument` API Reference](/docs/python-api-latest/model/instruments.html#vibe_trader.model.instruments.synthetic.SyntheticInstrument)
