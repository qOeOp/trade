...
:::note
Throughout the documentation, the term *"Vibe system boundary"* refers to operations within
the runtime of a single Vibe node (also known as a "trader instance").
:::
...
This is formalized in the `system` subpackage, where you will find the `VibeKernel` class,
