...
Whether the referenced `OrderFilled` is already in the local order history determines how Vibe
...
void a non-zero commission. Vibe does not reverse position or account exposure without a local
fill.
