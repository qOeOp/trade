...
[`bitmex_grid_market_maker.py`](https://github.com/qOeOp/trade/tree/main/examples/backtest/bitmex_grid_market_maker.py).
...
[`node_grid_mm.rs`](https://github.com/qOeOp/trade/tree/main/crates/adapters/bitmex/examples/node_grid_mm.rs):
