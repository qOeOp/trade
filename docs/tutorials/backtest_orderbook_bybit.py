...
# [Binance variant](https://github.com/qOeOp/trade/blob/main/docs/tutorials/backtest_orderbook_binance.py),
# different loader and different instrument.
#
# [View source on GitHub](https://github.com/qOeOp/trade/blob/main/docs/tutorials/backtest_orderbook_bybit.py).
