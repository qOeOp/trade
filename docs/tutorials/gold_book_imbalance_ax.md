...
[`architect_ax_book_imbalance.py`](https://github.com/qOeOp/trade/tree/main/examples/backtest/architect_ax_book_imbalance.py).
...
and writes PNGs to the asset directory using the `vibe_dark` tearsheet
theme.
...
[`ax_book_imbalance.py`](https://github.com/qOeOp/trade/tree/main/examples/live/architect_ax/ax_book_imbalance.py).
