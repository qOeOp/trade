...
#
# [View source on GitHub](https://github.com/qOeOp/trade/blob/main/docs/tutorials/backtest_orderbook_binance.py).
...
#   directory in `VIBE_DATA_DIR/Binance/`.
...
# directory using the shared `vibe_dark` tearsheet theme.
#
# ```bash
...
# ```
#
# Set `VIBE_DATA_DIR` to wherever your `Binance/` data directory lives.
