...
[`architect_ax_mean_reversion.py`](https://github.com/qOeOp/trade/tree/main/examples/backtest/architect_ax_mean_reversion.py).
...
captured bars, and writes PNG panels using the shared `vibe_dark`
tearsheet theme.
...
[`ax_mean_reversion.py`](https://github.com/qOeOp/trade/tree/main/examples/live/architect_ax/ax_mean_reversion.py).
