...
[`HurstVpinDirectional`](https://github.com/qOeOp/trade/tree/main/crates/trading/src/examples/strategies/hurst_vpin_directional)
in the `vibe_trading::examples::strategies` module. As with all
...
[`CryptoPerpetual`](https://github.com/qOeOp/trade/blob/main/crates/model/src/instruments/crypto_perpetual.rs).
...
The renderer uses the shared `vibe_dark` tearsheet theme and writes
...
- [`HurstVpinDirectional` strategy source](https://github.com/qOeOp/trade/tree/main/crates/trading/src/examples/strategies/hurst_vpin_directional)
