...
- **`B6` no deployment has admitted a provider yet.** The whole chain is verified end to end: on 2026-09-17 an
  ...
  `AAPL` quote. What remains is operational rather than structural: no running deployment has posted a binding to
  `/v1/market-data/source-bindings`, and the intake stays absent until one configures a Data Client.
...
| Vendor Data Clients                                       | `CURRENT / PARTIAL` | `crates/adapters/databento/src/pit_observation_source_v1.rs`, end-to-end verified by `crates/adapters/databento/tests/market_data_end_to_end.rs`                                                                                         | `B6`       |
