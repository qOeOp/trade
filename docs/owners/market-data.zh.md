...
cut：恰有一个报价 cut 严格位于帧的 BAR 与其上界之间，与帧共用 scope、Instrument Master、universe
selection、Market Semantics 与 Source Binding lineage，并且报价的成员恰好是帧的成员。现有 PIT correction lineage
