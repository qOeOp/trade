...
经济条款解析、Owner-binding、V1 native scheduling seal、V2 frame evidence 与 frame sequence 已准入单成员；
V1 scheduling receipt 声明其成员数，这属于报价 cut 对它的改变。`issue_cut` 还没有生产调用方。
