...
| R&D campaign / forward holdout | `modules/research/rd-campaign-runner` + `research.rd-campaign-runner`; forward holdout helpers remain in `modules/research/strategy-rd` until split |
