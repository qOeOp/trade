...
test("owner adapters use fixed scripts and only pass typed payloads", async () => {
  ...
  try {
    ...
    assert.equal(commands[0].script, "apps/artifact-knowledge/artifact-catalog/src/scripts/main.ts")
    ...
    assert.equal(commands[2].script, "apps/market-data-products/market-data-store/src/scripts/main.ts")
    ...
    assert.equal(commands[3].script, "apps/market-data-products/market-data-store/src/scripts/main.ts")
    ...
    assert.deepEqual(commands[4], {
      script: "apps/market-data-products/l2-order-book-service/src/scripts/owner-health.ts",
      args: [],
    })
    assert.deepEqual(commands[5], {
      script: "apps/orchestration-ops/l2-current-book-probe/src/scripts/consumer-read.ts",
      args: [],
    })
