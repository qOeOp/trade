...
export function preflightServerRuntime(
  ...
  const checks = [
    ...
    checkPath("l2_foreground_entry", resolve(root, "apps/market-data-products/l2-order-book-service/src/scripts/foreground.ts")),
    checkPath("l2_service_binary", resolve(root, "apps/market-data-products/l2-order-book-service/target/release/l2-order-book-service"), true),
    checkPath("l2_query_binary", resolve(root, "apps/market-data-products/l2-order-book-service/target/release/l2-order-book-query"), true),
    checkPath("consumer_foreground_entry", resolve(root, "apps/orchestration-ops/l2-current-book-probe/src/scripts/consumer-foreground.ts")),
    checkPath("control_runtime_entry", resolve(root, "apps/orchestration-ops/trade-flow/src/scripts/main.ts")),
...
export function readServerRuntimeStatus(
  ...
  const l2Envelope = ownerRead(execute, [
    bunPath,
    resolve(root, "apps/market-data-products/l2-order-book-service/src/scripts/owner-health.ts"),
  ], root)
  const consumerEnvelope = ownerRead(execute, [
    bunPath,
    resolve(root, "apps/orchestration-ops/l2-current-book-probe/src/scripts/consumer-read.ts"),
  ], root)
