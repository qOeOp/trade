...
const CERTIFICATION_TEST =
  "apps/research-strategy-development/replay-execution-plane/tests/src/replay-certification.test.ts"
const ENGINE_TEST =
  "apps/research-strategy-development/replay-execution-plane/engine/src/lib/replay-reference-engine.test.ts"
const TRIAL_TEST =
