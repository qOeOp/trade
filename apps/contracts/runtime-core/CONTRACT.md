...
- Shared resident-worker atomic state writes、bounded integer parsing、sanitized owner failure classes and interruptible exponential backoff. These helpers own mechanics only, never cadence or domain policy.
