...
use vibe_portfolio::{portfolio::Portfolio, python::PyPortfolio};
...
"#
    ...
    fn test_python_subscribe_and_unsubscribe_signal_update_msgbus() {
        use vibe_common::msgbus::{MessageBus, get_message_bus, switchboard::get_signal_topic};
