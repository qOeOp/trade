...
vibe_execution_algorithm!(TwapAlgorithm, {
...
mod tests {
    ...
    fn register_algorithm(algo: &mut TwapAlgorithm) {
        use vibe_common::timer::TimeEventCallback;
    ...
    fn test_twap_calculates_size_schedule_with_remainder() {
        ...
        add_instrument_to_cache(&algo);
        let instrument = vibe_model::instruments::stubs::crypto_perpetual_ethusdt();
    ...
    fn test_twap_submits_entire_size_when_qty_per_interval_below_size_increment() {
        use vibe_model::instruments::{InstrumentAny, stubs::equity_aapl};
