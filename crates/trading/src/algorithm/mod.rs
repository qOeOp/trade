...
/// # Implementation
///
/// Use the `vibe_execution_algorithm!` macro to generate the native runtime
...
mod tests {
    ...
    use super::*;
    use crate::vibe_execution_algorithm;
    ...
    vibe_execution_algorithm!(MacroTestCustomField, inner, {
        fn on_order(&mut self, _order: OrderAny) -> anyhow::Result<()> {
            Ok(())
        }
    });
    ...
    vibe_execution_algorithm!(TestAlgorithm, {
        fn on_order(&mut self, order: OrderAny) -> anyhow::Result<()> {
    ...
    fn test_algorithm_deny_order_does_not_publish_when_apply_fails() {
        ...
        let mut params = vibe_core::Params::new();
        params.insert(
            "route".to_string(),
    ...
    #[rstest]
    fn test_vibe_execution_algorithm_macro_custom_field() {
    ...
    fn test_algorithm_submit_order_list_captures_params_per_order() {
        ...
        use vibe_model::identifiers::OrderListId;
