...
use ustr::Ustr;
#[cfg(feature = "defi")]
use vibe_common::defi;
#[cfg(feature = "defi")]
use vibe_common::messages::defi::{
...
#[cfg(feature = "defi")]
use vibe_model::defi::tick_map::tick_math::get_tick_at_sqrt_ratio;
#[cfg(feature = "defi")]
use vibe_model::defi::{AmmType, Dex, DexType, chain::chains};
#[cfg(feature = "defi")]
use vibe_model::defi::{
...
#[cfg(feature = "streaming")]
use vibe_model::enums::{BookAction, OrderSide};
use vibe_model::{
    data::{
...
#[cfg(feature = "streaming")]
use vibe_persistence::backend::catalog::{ParquetDataCatalog, timestamps_to_filename};
#[cfg(feature = "streaming")]
use vibe_persistence::test_data::RustTestCustomData;
#[cfg(feature = "streaming")]
use vibe_serialization::ensure_custom_data_registered;
...
impl CatalogTempDir {
    fn new(label: &str) -> Self {
        let path = std::env::temp_dir().join(format!("vibe-data-engine-{label}-{}", UUID4::new()));
