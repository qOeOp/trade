...
use vibe_core::{UUID4, correctness::FAILED, datetime::millis_to_nanos_unchecked};
use vibe_model::{
...
impl OptionChainManager {
    ...
    fn maybe_rebalance(&mut self, now_ns: vibe_core::UnixNanos) {
    ...
    pub fn publish_slice(&mut self, ts: vibe_core::UnixNanos) {
...
mod tests {
    ...
    use vibe_model::{data::option_chain::StrikeRange, identifiers::Venue, types::Quantity};
    ...
    fn bootstrap_via_greeks(manager: &mut OptionChainManager) {
        use vibe_model::data::option_chain::OptionGreeks;
    ...
    fn test_manager_forward_price_rejects_invalid_underlying_without_buffering_greeks() {
        use vibe_model::data::{greeks::OptionGreekValues, option_chain::OptionGreeks};
