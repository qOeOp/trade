...
use vibe_serialization::{arrow::ArrowSchemaProvider, ensure_custom_data_registered};
...
fn test_quote_tick_query() {
    ...
    let file_path = get_vibe_test_data_file_path("quotes.parquet");
...
fn test_quote_tick_query_with_filter() {
    let file_path = get_vibe_test_data_file_path("quotes-3-groups-filter-query.parquet");
...
fn test_quote_tick_multiple_query() {
    ...
    let file_path_quotes = get_vibe_test_data_file_path("quotes.parquet");
    let file_path_trades = get_vibe_test_data_file_path("trades.parquet");
...
fn test_trade_tick_query() {
    ...
    let file_path = get_vibe_test_data_file_path("trades.parquet");
...
fn test_bar_query() {
    ...
    let file_path = get_vibe_test_data_file_path("bars.parquet");
...
fn test_datafusion_parquet_round_trip() {
    ...
    use vibe_serialization::arrow::EncodeToRecordBatch;
...
#[rstest]
fn test_rust_query_bars_inside_vibe_runtime() {
    let (_temp_dir, mut catalog) = create_temp_catalog();
...
fn test_make_local_path() {
    ...
    use vibe_persistence::backend::catalog::make_local_path;
...
fn test_safe_directory_identifier() {
    use vibe_persistence::backend::catalog::safe_directory_identifier;
...
fn test_make_object_store_path() {
    use vibe_persistence::backend::catalog::make_object_store_path;
...
fn test_make_object_store_path_owned() {
    use vibe_persistence::backend::catalog::make_object_store_path_owned;
...
fn test_local_to_object_store_path() {
    ...
    use vibe_persistence::backend::catalog::local_to_object_store_path;
...
fn test_extract_path_components() {
    use vibe_persistence::backend::catalog::extract_path_components;
...
fn test_extract_identifier_from_path() {
    use vibe_persistence::backend::catalog::extract_identifier_from_path;
...
fn test_make_sql_safe_identifier() {
    use vibe_persistence::backend::catalog::make_sql_safe_identifier;
...
fn test_extract_sql_safe_filename() {
    use vibe_persistence::backend::catalog::extract_sql_safe_filename;
...
fn test_rust_custom_data_roundtrip_with_params_field() {
    ...
    use vibe_model::data::{CustomData, Data, DataType};
