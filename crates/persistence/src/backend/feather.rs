...
use vibe_core::{UUID4, UnixNanos, datetime::NANOSECONDS_IN_SECOND};
use vibe_model::{
    data::{
...
use vibe_serialization::arrow::{EncodeToRecordBatch, KEY_INSTRUMENT_ID};
...
impl FeatherWriter {
    ...
    pub fn new(
        ...
        let runtime = vibe_common::live::get_runtime().handle().clone();
...
mod tests {
    ...
    async fn test_write_custom_data_round_trip() {
        ...
        use vibe_serialization::{arrow::custom::CustomDataDecoder, ensure_custom_data_registered};
