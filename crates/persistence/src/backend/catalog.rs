...
impl ParquetDataCatalog {
    ...
    /// use vibe_persistence::backend::catalog::ParquetDataCatalog;
    ///
    /// let catalog = ParquetDataCatalog::from_uri("/tmp/vibe_data", None, None, None, None)?;
    ...
    #[allow(
        ...
        reason = "Data::Defi appears through vibe-model feature unification"
    )]
    ...
    ///
    /// ```rust,no_run
    /// use vibe_model::instruments::InstrumentAny;
    /// use vibe_persistence::backend::catalog::ParquetDataCatalog;
    ///
    /// let catalog = ParquetDataCatalog::from_uri("/tmp/vibe_data", None, None, None, None)?;
    ...
    pub fn query_instruments_filtered(
        ...
        use vibe_serialization::arrow::instrument::decode_instrument_any_batch;
    ...
    ///
    /// ```rust,no_run
    /// use vibe_model::data::{Data, QuoteTick};
    /// use vibe_persistence::backend::catalog::ParquetDataCatalog;
    /// use vibe_core::UnixNanos;
    ///
    /// let mut catalog = ParquetDataCatalog::from_uri("/tmp/vibe_data", None, None, None, None)?;
    ///
    ...
    ///
    /// ```rust,no_run
    /// use vibe_model::data::{QuoteTick, TradeTick, Bar};
    /// use vibe_persistence::backend::catalog::ParquetDataCatalog;
    /// use vibe_core::UnixNanos;
    ///
    /// let mut catalog = ParquetDataCatalog::from_uri("/tmp/vibe_data", None, None, None, None)?;
    ...
    /// materializing Vibe data objects. It requires:
...
///
/// ```rust
/// use vibe_persistence::backend::catalog::CatalogPathPrefix;
/// use vibe_model::data::QuoteTick;
///
...
///
/// ```rust
/// # use vibe_persistence::backend::catalog::timestamps_to_filename;
/// # use vibe_core::UnixNanos;
...
///
/// ```rust
/// # use vibe_persistence::backend::catalog::urisafe_instrument_id;
...
///
/// ```rust
/// # use vibe_persistence::backend::catalog::parse_filename_timestamps;
...
///
/// ```rust
/// # use vibe_persistence::backend::catalog::are_intervals_disjoint;
/// // Disjoint intervals
...
///
/// ```rust
/// # use vibe_persistence::backend::catalog::are_intervals_contiguous;
