...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    match data_type {
        VibeDataType::QuoteTick => process_data::<QuoteTick>(file_str, &mut session)?,
        VibeDataType::TradeTick => process_data::<TradeTick>(file_str, &mut session)?,
        VibeDataType::Bar => process_data::<Bar>(file_str, &mut session)?,
        VibeDataType::OrderBookDelta => process_data::<OrderBookDelta>(file_str, &mut session)?,
