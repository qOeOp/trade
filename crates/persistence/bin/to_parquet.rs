...
use vibe_model::data::{Bar, OrderBookDelta, QuoteTick, TradeTick};
use vibe_persistence::python::backend::session::VibeDataType;
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    match data_type {
        VibeDataType::QuoteTick => process_data::<QuoteTick>(&file_path)?,
        VibeDataType::TradeTick => process_data::<TradeTick>(&file_path)?,
        VibeDataType::Bar => process_data::<Bar>(&file_path)?,
        VibeDataType::OrderBookDelta => process_data::<OrderBookDelta>(&file_path)?,
