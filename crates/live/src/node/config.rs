//! Configuration types for live Vibe system nodes.
...
use vibe_system::{
    config::{StreamingConfig, VibeKernelConfig},
...
#[cfg_attr(
    feature = "python",
    pyo3::pyclass(module = "vibe_trader.live", from_py_object)
)]
#[cfg_attr(
    feature = "python",
...
/// Configuration for live Vibe system nodes.
#[cfg_attr(
    feature = "python",
    pyo3::pyclass(module = "vibe_trader.live", from_py_object)
)]
...
impl VibeKernelConfig for LiveNodeConfig {
...
mod tests {
    use rstest::rstest;
    use vibe_system::config::RotationConfig;
    ...
    fn test_validate_runtime_support_accepts_file_config() {
        use vibe_common::logging::writer::FileWriterConfig;
