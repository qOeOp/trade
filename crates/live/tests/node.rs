...
use vibe_trading::{
    ExecutionAlgorithmConfig, ExecutionAlgorithmCore,
    strategy::{Strategy, StrategyConfig, StrategyCore},
    vibe_execution_algorithm, vibe_strategy,
};
...
vibe_strategy!(StopOnStartStrategy);
...
vibe_strategy!(ClaimingTestStrategy, {
...
vibe_execution_algorithm!(TestExecAlgorithm, {
...
// Run with: cargo nextest run -p vibe-live --test node
...
mod serial_tests {
    ...
    fn test_add_exec_algorithm_registers_execute_endpoint() {
        ...
        assert!(vibe_common::msgbus::has_endpoint("MY_ALGO.execute"));
    }
