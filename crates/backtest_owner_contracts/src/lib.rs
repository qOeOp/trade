...
/// Caller-authored lookup for one exact Backtest-owned result projection.
///
/// This locator carries no result authority. A positive projection is authoritative only while
/// held by the Backtest Owner sealed carrier returned from an Owner-verified result readback.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct BacktestResultProjectionLocatorV1 {
    ...
    pub canonical_result_digest: CanonicalDigestV2,
}

/// One exact commission amount retained by a canonical fill event.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct BacktestCommissionProjectionV1 {
    pub client_order_identity: String,
    pub trade_identity: String,
    pub amount: String,
}

/// One exact slippage value retained by a canonical order.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct BacktestSlippageProjectionV1 {
    pub client_order_identity: String,
    pub value: String,
}

/// One exact realized-PnL amount retained by a closed canonical position.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct BacktestRealizedPnlProjectionV1 {
    pub position_identity: String,
    pub amount: String,
}

/// One finite canonical return observation.
///
/// `value` is the canonical lowercase hexadecimal encoding of the finite IEEE-754 binary64 bits.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct BacktestReturnProjectionV1 {
    pub timestamp_ns: String,
    pub value: String,
}

/// Forgeable wire vocabulary for facts derived from one canonical Backtest result.
///
/// This DTO is deliberately dependency-neutral and carries no Backtest authority by itself. The
/// Backtest Owner sealed carrier is the positive read type.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct BacktestResultProjectionDtoV1 {
    ...
    pub attempt_identity: OpaqueIdentityV2,
    pub canonical_result_schema_identity: OpaqueIdentityV2,
    pub canonical_result_digest: CanonicalDigestV2,
    pub orders_count: u64,
    pub fills_count: u64,
    pub positions_count: u64,
    pub closed_round_trips_count: u64,
    pub terminal_flat: bool,
    pub commissions: Vec<BacktestCommissionProjectionV1>,
    pub slippages: Vec<BacktestSlippageProjectionV1>,
    pub realized_pnls: Vec<BacktestRealizedPnlProjectionV1>,
    pub returns_series: Vec<BacktestReturnProjectionV1>,
