...
pub use protected_replay::{
    ...
    ProtectedReplayAttemptFrontierMemberV1, ProtectedReplayAttemptFrontierOutboxDtoV1,
    ProtectedReplayAttemptFrontierOutboxPayloadDtoV1, ProtectedReplayAttemptFrontierReceiptDtoV1,
    ProtectedReplayContractErrorV1, ProtectedReplayReconciliationAtomV1,
    ProtectedReplayRequestDtoV1, ProtectedReplayRequestDtoV2, ProtectedReplayRequestSetLocatorV1,
    ...
    ProtectedReplayResultLocatorV3, ProtectedResultOutboxDtoV1, ProtectedResultOutboxPayloadDtoV1,
