//! Conversion implementations between Vibe types and Cap'n Proto.
...
impl<'a> ToCapnp<'a> for vibe_core::UUID4 {
...
impl<'a> FromCapnp<'a> for vibe_core::UUID4 {
...
impl<'a> FromCapnp<'a> for OrderBookDepth10 {
    ...
    fn from_capnp(reader: Self::Reader) -> Result<Self, Box<dyn Error>> {
        use vibe_model::data::order::NULL_ORDER;
...
impl<'a> FromCapnp<'a> for OrderDenied {
    ...
    fn from_capnp(reader: Self::Reader) -> Result<Self, Box<dyn Error>> {
        ...
        let event_id = vibe_core::UUID4::from_capnp(event_id_reader)?;
...
impl<'a> FromCapnp<'a> for OrderFillVoided {
    ...
    fn from_capnp(reader: Self::Reader) -> Result<Self, Box<dyn Error>> {
        ...
        let event_id = vibe_core::UUID4::from_capnp(reader.get_event_id()?)?;
        ...
        let causation_id = if reader.has_causation_id() {
            Some(vibe_core::UUID4::from_capnp(reader.get_causation_id()?)?)
        } else {
            None
        };
