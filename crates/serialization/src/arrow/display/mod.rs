//! Display-mode Arrow encoders for Vibe types.
//!
...
use vibe_model::types::{Money, Price, Quantity, fixed::MAX_FLOAT_PRECISION, price::PRICE_ERROR};
...
/// `vibe_model::defi::WEI_PRECISION` (18).
...
///
/// Vibe timestamps fit comfortably in `i64`, but this clamps defensively
