...
pub fn decode_betting_instrument_batch(
    ...
    for i in 0..num_rows {
        ...
        let event_open_date = vibe_core::UnixNanos::from(event_open_date_values.value(i));
        ...
        let market_start_time = vibe_core::UnixNanos::from(market_start_time_values.value(i));
