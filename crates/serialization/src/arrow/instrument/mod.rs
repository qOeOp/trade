...
mod tests {
    ...
    fn test_encode_decode_round_trip_equity() {
        use vibe_model::instruments::{Instrument, equity::Equity};
    ...
    #[case::binary_option(InstrumentAny::BinaryOption(
        vibe_model::instruments::stubs::binary_option()
    ))]
    #[case::cfd(InstrumentAny::Cfd(vibe_model::instruments::stubs::cfd_gold()))]
    #[case::commodity(InstrumentAny::Commodity(vibe_model::instruments::stubs::commodity_gold()))]
    #[case::crypto_future(InstrumentAny::CryptoFuture(
        vibe_model::instruments::stubs::crypto_future_btcusdt(
            2,
            6,
            Price::from("0.01"),
    ...
    #[case::crypto_futures_spread(InstrumentAny::CryptoFuturesSpread(
        vibe_model::instruments::stubs::crypto_futures_spread_btc_deribit()
    ))]
    #[case::crypto_option(InstrumentAny::CryptoOption(
        vibe_model::instruments::stubs::crypto_option_btc_deribit(
            3,
            1,
            Price::from("0.001"),
            Quantity::from("0.1"),
    ...
    #[case::crypto_option_spread(InstrumentAny::CryptoOptionSpread(
        vibe_model::instruments::stubs::crypto_option_spread_btc_deribit()
    ))]
    #[case::crypto_perpetual(InstrumentAny::CryptoPerpetual(
        vibe_model::instruments::stubs::crypto_perpetual_ethusdt()
    ))]
    #[case::currency_pair(InstrumentAny::CurrencyPair(
        vibe_model::instruments::stubs::currency_pair_btcusdt()
    ))]
    #[case::equity(InstrumentAny::Equity(vibe_model::instruments::stubs::equity_aapl()))]
    #[case::futures_contract(InstrumentAny::FuturesContract(
        vibe_model::instruments::stubs::futures_contract_es(None, None,)
    ))]
    #[case::futures_spread(InstrumentAny::FuturesSpread(
        vibe_model::instruments::stubs::futures_spread_es()
    ))]
    #[case::index_instrument(InstrumentAny::IndexInstrument(
        vibe_model::instruments::stubs::index_instrument_spx()
    ))]
    #[case::option_contract(InstrumentAny::OptionContract(
        vibe_model::instruments::stubs::option_contract_appl()
    ))]
    #[case::option_spread(InstrumentAny::OptionSpread(
        vibe_model::instruments::stubs::option_spread()
    ))]
    #[case::perpetual_contract(InstrumentAny::PerpetualContract(
        vibe_model::instruments::stubs::perpetual_contract_eurusd()
    ))]
    #[case::tokenized_asset(InstrumentAny::TokenizedAsset(
        vibe_model::instruments::stubs::tokenized_asset_aaplx()
    ))]
    ...
    fn test_roundtrip_crypto_option() {
        use vibe_model::instruments::stubs::crypto_option_btc_deribit;
    ...
    fn test_roundtrip_crypto_futures_spread() {
        use vibe_model::instruments::{Instrument, stubs::crypto_futures_spread_btc_deribit};
    ...
    fn test_roundtrip_crypto_option_spread() {
        use vibe_model::instruments::{Instrument, stubs::crypto_option_spread_btc_deribit};
    ...
    fn test_roundtrip_crypto_perpetual_inverse() {
        use vibe_model::instruments::stubs::xbtusd_bitmex;
        roundtrip_case(&InstrumentAny::CryptoPerpetual(xbtusd_bitmex()));
    }

    #[rstest]
    fn test_roundtrip_crypto_perpetual_linear() {
        use vibe_model::instruments::stubs::crypto_perpetual_ethusdt;
    ...
    fn test_roundtrip_futures_contract() {
        use vibe_model::instruments::stubs::futures_contract_es;
    ...
    fn test_roundtrip_tokenized_asset() {
        use vibe_model::instruments::stubs::tokenized_asset_aaplx;
