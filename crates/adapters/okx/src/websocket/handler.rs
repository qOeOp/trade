...
//!
//! All domain parsing (venue types to Vibe types) occurs outside the handler:
                    ...
                    match event {
                        ...
                        OKXWsFrame::Login {
                            ...
                            let error = OKXWebSocketError {
                                ...
                                timestamp: vibe_core::time::get_atomic_clock_realtime()
                                    .get_time_ns()
                                    .as_u64(),
                            };
...
mod tests {
    ...
    use rstest::rstest;
    use serde_json::json;
    use vibe_network::websocket::{AuthTracker, SubscriptionState};
