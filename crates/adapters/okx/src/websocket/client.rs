...
use crate::common::{
    consts::{
        OKX_SUPPORTED_ORDER_TYPES, OKX_SUPPORTED_TIME_IN_FORCE, OKX_VIBE_BROKER_ID,
...
impl OKXWebSocketClient {
    ...
    pub async fn connect(&mut self) -> anyhow::Result<()> {
        ...
        let headers = vec![(USER_AGENT.to_string(), VIBE_USER_AGENT.to_string())];
    ...
    pub async fn submit_order(
        ...
        builder.tag(OKX_VIBE_BROKER_ID);
    ...
    pub async fn submit_algo_order(
        ...
        // Map Vibe TriggerType to OKX trigger type
...
mod tests {
    ...
    fn test_websocket_error_handling() {
        ...
        let vibe_msg = OKXWsMessage::Error(error);
        match vibe_msg {
    ...
    async fn test_batch_cancel_orders_with_multiple_orders() {
        use vibe_model::identifiers::{ClientOrderId, InstrumentId, VenueOrderId};
    ...
    async fn test_batch_cancel_orders_with_only_client_order_id() {
        use vibe_model::identifiers::{ClientOrderId, InstrumentId};
    ...
    async fn test_batch_cancel_orders_with_only_venue_order_id() {
        use vibe_model::identifiers::{InstrumentId, VenueOrderId};
    ...
    async fn test_cancel_order_fails_without_inst_id_code() {
        use vibe_model::identifiers::{ClientOrderId, InstrumentId, StrategyId, TraderId};
