...
use vibe_okx::common::credential::Credential;
...
const BODY_LIMIT: &[u8] = br#"{"instId":"BTC-USDT-SWAP","tdMode":"cross","ccy":"USDT","clOrdId":"O-BENCH-LIM","tag":"vibe","side":"buy","ordType":"limit","sz":"0.001","px":"92572.0","reduceOnly":false}"#;
const BODY_ALGO: &[u8] = br#"[{"instId":"BTC-USDT-SWAP","tdMode":"cross","side":"sell","ordType":"trigger","sz":"0.001","algoClOrdId":"O-BENCH-STP","triggerPx":"90000.0","orderPx":"-1","triggerPxType":"last","tag":"vibe","reduceOnly":false}]"#;
