...
pub struct BinanceInstrumentProviderConfig {
    ...
    pub load_all: bool,
    /// Specific Vibe instrument IDs to load when `load_all` is false.
...
#[cfg(feature = "python")]
vibe_core::impl_pyo3_config_getters!(BinanceDataClientConfig {
...
#[cfg(feature = "python")]
vibe_core::impl_pyo3_config_getters!(BinanceExecClientConfig {
    trader_id: TraderId,
