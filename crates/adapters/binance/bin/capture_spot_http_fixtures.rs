...
//! `cargo run --bin binance-spot-http-capture-fixtures --package vibe-binance`
//!
...
async fn capture_public_fixtures(
    ...
    record_fixture(
        ...
        &FixtureCapture {
            ...
            parser_functions: &["vibe_binance::spot::http::parse::decode_ping"],
    ...
    record_fixture(
        ...
        &FixtureCapture {
            ...
            docs_url: SPOT_MARKET_DOCS,
            parser_functions: &["vibe_binance::spot::http::parse::decode_server_time"],
    ...
    record_fixture(
        ...
        &FixtureCapture {
            ...
            docs_url: SPOT_MARKET_DOCS,
            parser_functions: &[
                "vibe_binance::spot::http::parse::decode_exchange_info",
                "vibe_binance::common::parse::parse_spot_instrument_sbe",
            ],
    ...
    record_fixture(
        ...
        &FixtureCapture {
            ...
            docs_url: SPOT_MARKET_DOCS,
            parser_functions: &["vibe_binance::spot::http::parse::decode_depth"],
    ...
    record_fixture(
        ...
        &FixtureCapture {
            ...
            docs_url: SPOT_MARKET_DOCS,
            parser_functions: &[
                "vibe_binance::spot::http::parse::decode_trades",
                "vibe_binance::common::parse::parse_spot_trades_sbe",
            ],
            payload_relpath: &format!(
    ...
    record_fixture(
        ...
        &FixtureCapture {
            ...
            docs_url: SPOT_MARKET_DOCS,
            parser_functions: &[
                "vibe_binance::spot::http::parse::decode_klines",
                "vibe_binance::common::parse::parse_klines_to_bars",
            ],
            payload_relpath: &format!(
...
async fn capture_private_read_fixtures(
    ...
    record_fixture(
        ...
        &FixtureCapture {
            ...
            parser_functions: &["vibe_binance::spot::http::parse::decode_account"],
    ...
    record_fixture(
        ...
        &FixtureCapture {
            ...
            docs_url: SPOT_ACCOUNT_DOCS,
            parser_functions: &[
                "vibe_binance::spot::http::parse::decode_account_trades",
                "vibe_binance::common::parse::parse_fill_report_sbe",
            ],
            payload_relpath: &format!(
    ...
    record_fixture(
        ...
        &FixtureCapture {
            ...
            docs_url: SPOT_ACCOUNT_DOCS,
            parser_functions: &["vibe_binance::spot::http::parse::decode_orders"],
...
async fn capture_order_flow_fixtures(
    ...
    record_fixture(
        ...
        &FixtureCapture {
            ...
            parser_functions: &[
                "vibe_binance::spot::http::parse::decode_new_order_full",
                "vibe_binance::common::parse::parse_new_order_response_sbe",
            ],
    ...
    record_fixture(
        ...
        &FixtureCapture {
            ...
            docs_url: SPOT_TRADING_DOCS,
            parser_functions: &[
                "vibe_binance::spot::http::parse::decode_order",
                "vibe_binance::common::parse::parse_order_status_report_sbe",
            ],
    ...
    record_fixture(
        ...
        &FixtureCapture {
            ...
            endpoint: "/api/v3/order",
            docs_url: SPOT_TRADING_DOCS,
            parser_functions: &["vibe_binance::spot::http::parse::decode_cancel_order"],
    ...
    record_fixture(
        ...
        &FixtureCapture {
            ...
            endpoint: "/api/v3/order",
            docs_url: SPOT_TRADING_DOCS,
            parser_functions: &["vibe_binance::spot::http::parse::decode_new_order_full"],
    ...
    record_fixture(
        ...
        &FixtureCapture {
            ...
            endpoint: "/api/v3/openOrders",
            docs_url: SPOT_TRADING_DOCS,
            parser_functions: &["vibe_binance::spot::http::parse::decode_cancel_open_orders"],
...
fn print_usage() {
    println!(
        "Usage: cargo run --bin binance-spot-http-capture-fixtures --package vibe-binance -- [OPTIONS]\n\
         \n\
         Options:\n\
