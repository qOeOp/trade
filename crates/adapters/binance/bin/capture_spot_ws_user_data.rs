...
//! ```bash
//! cargo run --bin binance-spot-ws-user-data-capture --package vibe-binance -- \
//!   --environment testnet
//! ```
//!
...
fn parser_functions(template_id: u16) -> &'static [&'static str] {
    match template_id {
        601 => &["vibe_binance::spot::websocket::trading::decode_sbe::decode_balance_update"],
        603 => &["vibe_binance::spot::websocket::trading::decode_sbe::decode_execution_report"],
        607 => &["vibe_binance::spot::websocket::trading::decode_sbe::decode_account_position"],
        _ => &[],
    }
}
...
fn print_usage() {
    println!(
        "Usage: cargo run --bin binance-spot-ws-user-data-capture --package vibe-binance -- [OPTIONS]\n\
         \n\
         Options:\n\
