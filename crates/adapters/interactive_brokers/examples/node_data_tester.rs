...
//!
//! Run live smoke with:
//! `cargo run --example ib-data-tester --package vibe-interactive-brokers --features examples`
//!
//! Run embedded config unit tests with:
//! `cargo test --example ib-data-tester --package vibe-interactive-brokers --features examples`
//!
...
use vibe_live::{config::RoutingConfig, node::LiveNode};
use vibe_model::{
    data::bar::BarType,
