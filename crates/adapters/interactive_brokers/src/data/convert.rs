...
/// Convert Vibe BarType to IB HistoricalBarSize.
///
/// # Errors
///
...
/// Convert Vibe PriceType to IB WhatToShow.
#[must_use]
...
/// Convert Vibe PriceType to IB WhatToShow for historical bars, mapping crypto
...
/// Convert Vibe PriceType to IB WhatToShow for real-time (5-second) bars.
///
...
/// Convert Vibe PriceType to IB WhatToShow for real-time (5-second) bars, mapping
...
mod tests {
    ...
    fn test_ib_bar_to_vibe_bar() {
        ...
        let result = ib_bar_to_vibe_bar(&ib_bar, bar_type, 2, 0);
        assert!(result.is_ok());
    ...
    #[rstest]
    fn test_ib_bar_to_vibe_bar_negative_volume() {
        let ib_bar = ibapi::market_data::historical::Bar {
            date: datetime!(2024-01-01 10:00:00 UTC).into(),
            open: 150.0,
            high: 151.0,
