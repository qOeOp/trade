...
use super::{
    ...
    convert::{
        ...
        calculate_duration, calculate_duration_segments, ib_bar_to_vibe_bar, jiff_to_ib_datetime,
...
fn parse_start_ns(params: Option<&vibe_core::Params>) -> Option<UnixNanos> {
    params
                    ...
                    Ok(historical_data) => {
                        ...
                        for ib_bar in &historical_data.bars {
                            ...
                            match ib_bar_to_vibe_bar(
                                ...
                                Err(e) => {
                                    tracing::warn!("Failed to convert IB bar to Vibe bar: {:?}", e);
                                }
                            }
                        }
                    }
...
mod tests {
    ...
    fn test_venue_is_none_for_default_routing() {
        ...
        vibe_common::live::runner::replace_data_event_sender(sender);
