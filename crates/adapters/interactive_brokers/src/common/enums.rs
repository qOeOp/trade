...
mod tests {
    ...
    use vibe_model::enums::{
        OptionKind, OrderSide, OrderStatus as VibeOrderStatus, OrderType as VibeOrderType,
    ...
    #[rstest]
    #[case("ApiPending", IbOrderStatus::ApiPending, VibeOrderStatus::Submitted)]
    #[case(
        "PendingSubmit",
    ...
    #[case("Submitted", IbOrderStatus::Submitted, VibeOrderStatus::Accepted)]
    #[case(
        "PendingCancel",
        IbOrderStatus::PendingCancel,
        VibeOrderStatus::PendingCancel
    )]
    #[case("ApiCancelled", IbOrderStatus::ApiCancelled, VibeOrderStatus::Canceled)]
    #[case("Cancelled", IbOrderStatus::Cancelled, VibeOrderStatus::Canceled)]
    #[case("Filled", IbOrderStatus::Filled, VibeOrderStatus::Filled)]
    #[case("Inactive", IbOrderStatus::Inactive, VibeOrderStatus::Rejected)]
    fn test_ib_order_status_parse(
        #[case] value: &str,
        #[case] expected_status: IbOrderStatus,
        #[case] expected_vibe_status: VibeOrderStatus,
    ) {
        let status = IbOrderStatus::from_str(value).unwrap();
        assert_eq!(status, expected_status);
        assert_eq!(status.vibe_status(), expected_vibe_status);
        assert_eq!(status.to_string(), value);
    }

    #[rstest]
    #[case("MKT", IbOrderType::Market, VibeOrderType::Market)]
    #[case("MOC", IbOrderType::MarketOnClose, VibeOrderType::Market)]
    #[case("LMT", IbOrderType::Limit, VibeOrderType::Limit)]
    #[case("LOC", IbOrderType::LimitOnClose, VibeOrderType::Limit)]
    #[case("STP", IbOrderType::Stop, VibeOrderType::StopMarket)]
    #[case("STP LMT", IbOrderType::StopLimit, VibeOrderType::StopLimit)]
    #[case("TRAIL", IbOrderType::TrailingStop, VibeOrderType::TrailingStopMarket)]
    #[case(
        "TRAIL LIMIT",
        IbOrderType::TrailingStopLimit,
        VibeOrderType::TrailingStopLimit
    )]
    #[case("MIT", IbOrderType::MarketIfTouched, VibeOrderType::MarketIfTouched)]
    #[case("LIT", IbOrderType::LimitIfTouched, VibeOrderType::LimitIfTouched)]
    #[case("MTL", IbOrderType::MarketToLimit, VibeOrderType::MarketToLimit)]
    fn test_ib_order_type_parse(
        #[case] value: &str,
        #[case] expected_order_type: IbOrderType,
        #[case] expected_vibe_order_type: VibeOrderType,
    ) {
        let order_type = IbOrderType::from_str(value).unwrap();
        assert_eq!(order_type, expected_order_type);
        assert_eq!(order_type.vibe_order_type(), expected_vibe_order_type);
    ...
    #[rstest]
    fn test_ib_order_type_wire_roundtrip_preserves_vibe_order_type() {
        let order_types = [
            IbOrderType::Market,
        ...
        for order_type in order_types {
            ...
            assert_eq!(
                parsed.vibe_order_type(),
                order_type.vibe_order_type(),
    ...
    #[rstest]
    #[case("DAY", IbTimeInForce::Day, VibeTimeInForce::Day)]
    #[case("GTC", IbTimeInForce::GoodTilCanceled, VibeTimeInForce::Gtc)]
    #[case("IOC", IbTimeInForce::ImmediateOrCancel, VibeTimeInForce::Ioc)]
    #[case("GTD", IbTimeInForce::GoodTilDate, VibeTimeInForce::Gtd)]
    #[case("OPG", IbTimeInForce::OnOpen, VibeTimeInForce::AtTheOpen)]
    #[case("FOK", IbTimeInForce::FillOrKill, VibeTimeInForce::Fok)]
    #[case("DTC", IbTimeInForce::DayTilCanceled, VibeTimeInForce::Day)]
    #[case("AUC", IbTimeInForce::Auction, VibeTimeInForce::Day)]
    fn test_ib_time_in_force_parse(
        #[case] value: &str,
        #[case] expected_time_in_force: IbTimeInForce,
        #[case] expected_vibe_time_in_force: VibeTimeInForce,
    ) {
        let time_in_force = IbTimeInForce::from_str(value).unwrap();
        assert_eq!(time_in_force, expected_time_in_force);
        assert_eq!(
            time_in_force.vibe_time_in_force(),
            expected_vibe_time_in_force
        );
