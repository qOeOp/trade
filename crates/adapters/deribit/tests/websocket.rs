...
use vibe_core::{AtomicSet, UnixNanos};
use vibe_deribit::{
...
use vibe_network::websocket::{AuthTracker, SubscriptionState, TransportBackend};
...
async fn test_user_subscription_confirmed_after_auth() {
    ...
    client
        .authenticate_session("vibe-test")
        .await
        .expect("auth failed");
