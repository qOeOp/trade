...
//!
//! Run with: `cargo run --example deribit-option-chain-tester --package vibe-deribit --features examples`
//!
...
impl DataActor for OptionChainTester {
    fn on_start(&mut self) -> anyhow::Result<()> {
        ...
        let series_id = OptionSeriesId::new(
            ...
            underlying_filter,
            settlement_currency,
            vibe_core::UnixNanos::from(nearest_expiry),
        );
