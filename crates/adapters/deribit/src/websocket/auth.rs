...
use vibe_core::{UUID4, time::get_atomic_clock_realtime};
...
pub const DERIBIT_DATA_SESSION_NAME: &str = "vibe-data";

/// Session name for Deribit WebSocket execution client authentication.
pub const DERIBIT_EXECUTION_SESSION_NAME: &str = "vibe-execution";
...
/// - `scope` - Optional scope (e.g., "session:vibe" for session-based auth)
