...
use ustr::Ustr;
use vibe_core::serialization::{deserialize_decimal, deserialize_optional_decimal};
use vibe_model::{
    data::{
...
impl DeribitGreeks {
    /// Converts Deribit Greeks (Decimal) to Vibe `OptionGreekValues` (f64).
...
pub struct DeribitOrderMsg {
    ...
    #[serde(deserialize_with = "vibe_core::serialization::deserialize_decimal")]
    pub amount: Decimal,
    ...
    #[serde(
        default,
        deserialize_with = "vibe_core::serialization::deserialize_optional_decimal"
    )]
    ...
    #[serde(
        default,
        deserialize_with = "vibe_core::serialization::deserialize_decimal"
    )]
...
pub struct DeribitUserTradeMsg {
    ...
    /// Execution price.
    #[serde(
        serialize_with = "vibe_core::serialization::serialize_decimal",
        deserialize_with = "vibe_core::serialization::deserialize_decimal"
    )]
    pub price: Decimal,
    ...
    #[serde(
        default,
        serialize_with = "vibe_core::serialization::serialize_optional_decimal",
        deserialize_with = "vibe_core::serialization::deserialize_optional_decimal"
    )]
...
/// Normalized Vibe domain message after parsing.
#[derive(Debug, Clone)]
