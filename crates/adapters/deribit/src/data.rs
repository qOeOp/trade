...
use crate::{
    ...
    websocket::{
        ...
        enums::DeribitUpdateInterval, messages::VibeWsMessage,
    },
};
...
impl DeribitDataClient {
    ...
    fn handle_ws_message(
        message: VibeWsMessage,
        sender: &tokio::sync::mpsc::UnboundedSender<DataEvent>,
        instruments: &Arc<AtomicMap<InstrumentId, InstrumentAny>>,
    ) {
        match message {
            VibeWsMessage::Data(payloads) => {
            ...
            VibeWsMessage::Instrument(instrument) => {
            ...
            VibeWsMessage::FundingRates(funding_rates) => {
