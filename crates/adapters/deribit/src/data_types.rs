...
//!
//! These types carry Deribit domain data through the Vibe data engine as
...
pub fn register_deribit_custom_data() {
    #[cfg(feature = "arrow")]
    {
        vibe_serialization::ensure_custom_data_registered::<DeribitVolatilityIndex>();
        vibe_serialization::ensure_custom_data_registered::<DeribitBookSummary>();
    }

    #[cfg(not(feature = "arrow"))]
    {
        let _ = vibe_model::data::ensure_custom_data_json_registered::<DeribitVolatilityIndex>();
        let _ = vibe_model::data::ensure_custom_data_json_registered::<DeribitBookSummary>();
    }
}
