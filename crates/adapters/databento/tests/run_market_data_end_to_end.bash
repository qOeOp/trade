...
container="vibe-md-e2e-${PPID}-$$"
database="vibe_test_market_data_e2e_${PPID}_$$"
marker="md-e2e-${PPID}-$$"
...
if [[ -z "${DATABENTO_API_KEY:-}" ]]; then
  echo "market-data end-to-end: DATABENTO_API_KEY is required for the live vendor leg" >&2
  exit 1
fi
