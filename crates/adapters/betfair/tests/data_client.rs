...
async fn test_data_client_subscribe_sends_market_subscription() {
    ...
    let instrument_id = vibe_betfair::common::parse::make_instrument_id(
        "1.180294978",
        6146434,
...
async fn test_data_client_deduplicates_same_market_subscription() {
    ...
    let first_instrument_id = vibe_betfair::common::parse::make_instrument_id(
        "1.180294978",
        6146434,
        rust_decimal::Decimal::ZERO,
    );
    let second_instrument_id = vibe_betfair::common::parse::make_instrument_id(
        "1.180294978",
        40273293,
        rust_decimal::Decimal::ZERO,
    );
