...
//! 1. Load raw Betfair `.gz` streaming data into Vibe domain objects
...
//!
//! Run with: `cargo run -p vibe-betfair --features examples --example betfair-backtest`
//!
//! Or pass a custom file path:
//!   `cargo run -p vibe-betfair --features examples --example betfair-backtest -- path/to/file.gz`
//!
