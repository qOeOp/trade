...
//! newline-delimited Betfair ESA messages and produces Vibe domain
...
/// Reads Betfair historical data files and converts them into Vibe domain objects.
///
...
impl BetfairDataLoader {
    ...
    /// messages are parsed into Vibe domain objects; other message types
    /// are skipped.
    ///
    /// # Errors
    ///
...
mod tests {
    ...
    fn test_load_rcm_uses_publish_time_as_ts_init() {
        ...
        let expected_event = vibe_core::UnixNanos::from(1_583_685_064_600_000_000);
        let expected_init = vibe_core::UnixNanos::from(1_583_685_064_634_000_000);
