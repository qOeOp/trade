//! Parsing utilities that convert Betfair HTTP/REST responses into Vibe domain models.
...
/// Parses a Betfair [`CurrentOrderSummary`] into a Vibe [`OrderStatusReport`].
///
/// # Errors
///
...
/// Parses a Betfair [`CurrentOrderSummary`] into a Vibe [`FillReport`].
///
