...
//!
//! These types carry Betfair domain data through the Vibe data engine as
//! [`CustomData`](vibe_model::data::CustomData). Each type uses the
...
pub fn register_betfair_custom_data() {
    vibe_serialization::ensure_custom_data_registered::<BetfairTicker>();
    vibe_serialization::ensure_custom_data_registered::<BetfairStartingPrice>();
    vibe_serialization::ensure_custom_data_registered::<BetfairBspBookDelta>();
    vibe_serialization::ensure_custom_data_registered::<BetfairSequenceCompleted>();
    vibe_serialization::ensure_custom_data_registered::<BetfairOrderVoided>();
    vibe_serialization::ensure_custom_data_registered::<BetfairRaceRunnerData>();
    vibe_serialization::ensure_custom_data_registered::<BetfairRaceProgress>();
    vibe_serialization::ensure_custom_data_registered::<BetfairCricketMatch>();
}
