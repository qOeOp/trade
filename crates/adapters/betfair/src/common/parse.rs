//! Parsing utilities that convert Betfair payloads into Vibe domain models.
...
/// Constructs a Vibe [`Symbol`] from Betfair market and selection identifiers.
///
...
/// Constructs a Vibe [`InstrumentId`] from Betfair market and selection identifiers.
///
...
/// Converts a Betfair decimal price into a Vibe [`Price`].
///
/// # Errors
///
...
/// Normalizes a Betfair quantity to Vibe quantity precision.
#[must_use]
...
/// Parses a Betfair [`AccountFundsResponse`] into a Vibe [`AccountState`].
///
/// # Errors
///
...
/// Extracts the Betfair market ID from a Vibe instrument ID.
///
...
/// Extracts the selection ID and handicap from a Vibe instrument ID.
///
/// # Errors
///
