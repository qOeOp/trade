...
use vibe_core::{AtomicMap, MUTEX_POISONED};
use vibe_model::{
    data::BarType,
...
use crate::{
    ...
    websocket::{
        ...
        messages::{
            PostRequest, PostResponse, PostResponsePayload, SubscriptionRequest, VibeWsMessage,
        },
...
impl HyperliquidWebSocketClient {
    ...
    /// `VibeWsMessage::Depth10` for this coin.
