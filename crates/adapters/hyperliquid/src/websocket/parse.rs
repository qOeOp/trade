...
use vibe_core::{nanos::UnixNanos, uuid::UUID4};
use vibe_model::{
    data::{
...
///
/// This converts Hyperliquid order data from WebSocket into Vibe order status reports.
...
///
/// This converts Hyperliquid fill data from WebSocket user events into Vibe fill reports.
...
///
/// This converts Hyperliquid asset context data into Vibe price and funding rate updates.
