...
use ustr::Ustr;
use vibe_core::{MUTEX_POISONED, UUID4, UnixNanos};
...
///
/// Stored in [`WsDispatchState::order_identities`] keyed by the full Vibe
...
pub struct WsDispatchState {
    /// Tracked orders keyed by full Vibe [`ClientOrderId`].
...
mod tests {
    ...
    use vibe_model::identifiers::{ClientOrderId, InstrumentId, StrategyId, TradeId};
