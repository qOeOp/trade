...
use vibe_core::python::{
    IntoPyObjectVibeExt, call_python_threadsafe, to_pyruntime_err, to_pyvalue_err,
};
use vibe_model::{
...
use crate::{
    ...
    websocket::{
        ...
        messages::{ExecutionReport, VibeWsMessage},
    },
};
                ...
                loop {
                    ...
                    match event {
                        Some(msg) => {
                            ...
                            match msg {
                                VibeWsMessage::Trades(trade_ticks) => {
                                    Python::attach(|py| {
                                ...
                                VibeWsMessage::Quote(quote_tick) => {
                                    Python::attach(|py| {
                                        send_data_to_python(
                                            py,
                                ...
                                VibeWsMessage::MarkPrice(mark_price) => {
                                    Python::attach(|py| {
                                        send_data_to_python(
                                            py,
                                ...
                                VibeWsMessage::IndexPrice(index_price) => {
                                    Python::attach(|py| {
                                        send_data_to_python(
                                            py,
                                ...
                                VibeWsMessage::FundingRate(funding_rate) => {
                                    Python::attach(|py| {
