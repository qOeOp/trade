...
//!
//! These types carry Hyperliquid domain data through the Vibe data engine as
...
/// generic [`TradeTick`](vibe_model::data::TradeTick), and is self-contained
...
pub fn register_hyperliquid_custom_data() {
    #[cfg(feature = "arrow")]
    {
        vibe_serialization::ensure_custom_data_registered::<HyperliquidAllMids>();
        vibe_serialization::ensure_custom_data_registered::<HyperliquidOpenInterest>();
        vibe_serialization::ensure_custom_data_registered::<HyperliquidPublicTrade>();
    }

    #[cfg(not(feature = "arrow"))]
    {
        let _ = vibe_model::data::ensure_custom_data_json_registered::<HyperliquidAllMids>();
        let _ = vibe_model::data::ensure_custom_data_json_registered::<HyperliquidOpenInterest>();
        let _ = vibe_model::data::ensure_custom_data_json_registered::<HyperliquidPublicTrade>();
    }

    let _ = vibe_model::data::ensure_custom_data_json_registered::<HyperliquidAllDexsAssetCtxs>();
}
...
mod tests {
    ...
    fn test_hyperliquid_all_mids_arrow_schema() {
        ...
        use vibe_serialization::arrow::ArrowSchemaProvider;
    ...
    fn test_hyperliquid_open_interest_arrow_round_trip_preserves_decimal() {
        ...
        use vibe_serialization::arrow::{DecodeDataFromRecordBatch, EncodeToRecordBatch};
