...
//! Run with:
//! ```bash
//! cargo run -p vibe-hyperliquid --bin hyperliquid-flatten            # mainnet (default)
//! cargo run -p vibe-hyperliquid --bin hyperliquid-flatten -- testnet # testnet
//! ```
//!
...
mod tests {
    ...
    use vibe_hyperliquid::{common::consts::HYPERLIQUID_VENUE, http::models::HyperliquidLevel};
    use vibe_model::{
