...
setarch -R cargo bench -p vibe-hyperliquid --profile bench-lto \
...
Raw WS frame bytes -> Vibe domain type. Covers decode + parse + cache
lookup + Vibe type construction. No I/O, no async runtime, no channel.
