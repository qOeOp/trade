//! WebSocket message parsers for converting Kraken Futures streaming data to Vibe domain models.

use anyhow::Context;
use rust_decimal::Decimal;
use vibe_core::{UUID4, datetime::NANOSECONDS_IN_MILLISECOND, nanos::UnixNanos};
use vibe_model::{
    data::{
