...
use vibe_core::{
    AtomicMap, AtomicTime, UUID4, consts::VIBE_USER_AGENT, datetime::NANOSECONDS_IN_SECOND,
...
///
/// This client wraps the raw client and provides Vibe domain types.
/// It maintains an instrument cache and uses it to parse venue responses
/// into Vibe domain objects.
#[cfg_attr(
    feature = "python",
...
impl KrakenSpotHttpClient {
    ...
    ///
    /// [`vibe_model::accounts::MarginAccount::recalculate_balance`] sums
...
/// Resolves the Vibe [`Currency`] used to denominate `TradeBalance` margin metrics.
///
...
mod tests {
    use rstest::rstest;
    use vibe_model::instruments::CurrencyPair;
