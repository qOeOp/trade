...
use vibe_model::enums::{LiquiditySide, MarketStatusAction, OrderSide, OrderStatus, OrderType};
...
impl From<KrakenOrderType> for OrderType {
    /// Maps Kraken order types to Vibe order types for reconciliation.
    ///
...
mod tests {
    use rstest::rstest;
    use vibe_model::enums::{LiquiditySide, MarketStatusAction, OrderType};
