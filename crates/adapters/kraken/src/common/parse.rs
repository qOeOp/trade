//! Conversion helpers that translate Kraken API schemas into Vibe domain models.
...
use vibe_core::{datetime::NANOSECONDS_IN_MILLISECOND, nanos::UnixNanos, uuid::UUID4};
use vibe_model::{
...
/// Parse Kraken spot trigger to Vibe TriggerType.
...
/// Parse Kraken futures trigger signal to Vibe TriggerType.
...
/// Parses a Kraken asset pair definition into a Vibe currency pair instrument.
///
/// # Errors
///
/// Returns an error if:
...
/// Parses a Kraken tokenized asset pair into a Vibe tokenized asset instrument.
///
...
/// Parses a Kraken futures instrument definition into a Vibe crypto perpetual instrument.
///
/// # Errors
///
/// Returns an error if:
...
/// Parses a Kraken trade array into a Vibe trade tick.
///
...
/// Parses a Kraken Futures public execution into a Vibe trade tick.
///
/// # Errors
///
/// Returns an error if:
...
/// Parses a Kraken OHLC entry into a Vibe bar.
///
/// # Errors
///
/// Returns an error if:
...
/// Parses a Kraken spot order into a Vibe OrderStatusReport.
///
/// # Errors
///
/// Returns an error if:
...
/// Parses a Kraken spot trade into a Vibe FillReport.
///
/// # Errors
///
/// Returns an error if:
...
/// Parses a Kraken futures open order into a Vibe OrderStatusReport.
///
/// # Errors
///
...
/// Parses a Kraken futures order event (historical order) into a Vibe OrderStatusReport.
///
/// # Errors
///
/// Returns an error if order ID, quantities, or prices cannot be parsed.
...
/// Parses a Kraken futures fill into a Vibe FillReport.
///
/// # Errors
///
...
/// Parses a Kraken futures position into a Vibe PositionStatusReport.
///
/// # Errors
///
...
/// Converts a Vibe BarType to Kraken Spot API interval (in minutes).
///
/// # Errors
///
/// Returns an error if:
...
/// Converts a Vibe BarType to Kraken Futures API resolution string.
///
