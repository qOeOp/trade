...
use crate::{
    ...
    websocket::{client::CoinbaseWebSocketClient, handler::VibeWsMessage},
};
...
fn dispatch_ws_message(
    ...
    match msg {
        ...
        VibeWsMessage::FuturesBalanceSummary(_) => {
...
mod tests {
    use rstest::rstest;
    use vibe_common::{live::runner::set_data_event_sender, messages::data::SubscribeMarkPrices};
    ...
    fn make_status_event(instrument_id: InstrumentId) -> VibeWsMessage {
        use vibe_model::{data::InstrumentStatus, enums::MarketStatusAction};
        ...
        VibeWsMessage::InstrumentStatus(Box::new(status))
    }
    ...
    async fn test_subscribe_instrument_status_records_and_idempotent() {
        use vibe_common::messages::data::SubscribeInstrumentStatus;
    ...
    async fn test_unsubscribe_instrument_status_emptying_set() {
        use vibe_common::messages::data::{SubscribeInstrumentStatus, UnsubscribeInstrumentStatus};
