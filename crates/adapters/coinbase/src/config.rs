...
#[cfg_attr(
    feature = "python",
    pyo3_stub_gen::derive::gen_stub_pyclass(module = "vibe_trader.adapters.coinbase")
)]
...
#[cfg(feature = "python")]
vibe_core::impl_pyo3_config_getters!(CoinbaseDataClientConfig {
...
#[cfg(feature = "python")]
vibe_core::impl_pyo3_config_getters!(CoinbaseExecClientConfig {
    base_url_rest: Option<String>,
    base_url_ws: Option<String>,
    environment: CoinbaseEnvironment,
    http_timeout_secs: u64,
