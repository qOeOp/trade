//! Conversion functions that translate AX API schemas into Vibe types.
...
const TRADE_ID_DOMAIN: &[u8] = b"vibe-architect-ax/trade-id/v1";
...
/// Only a consumer that itself deduplicates on [`TradeId`] is affected; nothing in the Vibe
...
/// Maps a Vibe [`BarSpecification`] to an [`AxCandleWidth`].
///
/// # Errors
///
