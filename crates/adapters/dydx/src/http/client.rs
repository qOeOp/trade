...
//! - [`DydxHttpClient`]: High-level methods using Vibe domain types with instrument caching.
//!
...
//! and provides high-level methods that work with Vibe domain types.
//!
//! ## Responsibilities
//!
...
use vibe_model::{
    ...
    enums::{
        AggregationSource, BarAggregation, BookAction, OrderSide as VibeOrderSide, PriceType,
        RecordFlag,
    },
    events::AccountState,
