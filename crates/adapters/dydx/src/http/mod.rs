...
//! - **Rate limiting**: Automatic rate limiting and retry logic via `vibe_network::http::HttpClient`.
//!
//! # Architecture
//!
...
//! - **Domain client** ([`client::DydxHttpClient`]): High-level methods using Vibe domain types,
