...
//!
//! This module converts Vibe order types to dYdX proto messages (`MsgPlaceOrder`,
...
/// Builds dYdX proto messages from Vibe orders.
///
/// # Responsibilities
///
/// - Convert Vibe order types to dYdX protocol messages
...
impl OrderMessageBuilder {
    ...
    fn expire_time_to_secs(
        &self,
        order_expire_time_ns: Option<vibe_core::UnixNanos>,
    ) -> Option<i64> {
    ...
    pub fn is_short_term_cancel(
        ...
        expire_time_ns: Option<vibe_core::UnixNanos>,
    ) -> bool {
    ...
    pub fn build_cancel_orders_batch(
        &self,
        orders: &[(InstrumentId, u32, TimeInForce, Option<vibe_core::UnixNanos>)],
        block_height: u32,
    ) -> Result<Vec<Any>, DydxError> {
        orders
            .iter()
    ...
    pub fn build_cancel_and_replace(
        ...
        old_expire_time_ns: Option<vibe_core::UnixNanos>,
