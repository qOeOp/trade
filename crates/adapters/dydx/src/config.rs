...
use vibe_network::{ratelimiter::quota::Quota, websocket::TransportBackend};
...
#[cfg(feature = "python")]
vibe_core::impl_pyo3_config_getters!(DydxDataClientConfig {
    network: DydxNetwork,
});
...
#[cfg(feature = "python")]
vibe_core::impl_pyo3_config_getters!(DydxExecClientConfig {
    trader_id: TraderId,
