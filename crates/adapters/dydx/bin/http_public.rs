...
//! cargo run --bin dydx-http-public -p vibe-dydx
//!
//! # Test against mainnet
//! cargo run --bin dydx-http-public -p vibe-dydx -- --mainnet
//!
//! # Test specific symbol
//! cargo run --bin dydx-http-public -p vibe-dydx -- --symbol ETH-USD
//!
//! # Show instrument summary (grouped by type and base asset)
//! cargo run --bin dydx-http-public -p vibe-dydx -- --summary
//!
//! # Custom URL via environment variable
//! DYDX_HTTP_URL=https://indexer.dydx.trade cargo run --bin dydx-http-public -p vibe-dydx
//! ```
