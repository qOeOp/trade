...
//! cargo run --bin dydx-ws-data -p vibe-dydx
//!
//! # Subscribe to specific channel
//! cargo run --bin dydx-ws-data -p vibe-dydx -- trades BTC-USD
//! cargo run --bin dydx-ws-data -p vibe-dydx -- orderbook ETH-USD
//! cargo run --bin dydx-ws-data -p vibe-dydx -- candles BTC-USD
//!
//! # Use testnet explicitly
//! cargo run --bin dydx-ws-data -p vibe-dydx -- all BTC-USD testnet
//!
