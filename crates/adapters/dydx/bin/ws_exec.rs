...
//! DYDX_TESTNET_PRIVATE_KEY="your hex private key" cargo run --bin dydx-ws-exec -p vibe-dydx
//!
...
//! cargo run --bin dydx-ws-exec -p vibe-dydx -- --mainnet
//!
//! # With custom subaccount
//! DYDX_PRIVATE_KEY="your hex private key" cargo run --bin dydx-ws-exec -p vibe-dydx -- --subaccount 1
//! ```
