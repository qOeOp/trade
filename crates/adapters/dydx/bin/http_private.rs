...
//! DYDX_TESTNET_PRIVATE_KEY="your hex private key" cargo run --bin dydx-http-private -p vibe-dydx
//!
//! # Test against mainnet
//! DYDX_PRIVATE_KEY="your hex private key" \
//! DYDX_HTTP_URL=https://indexer.dydx.trade \
//! cargo run --bin dydx-http-private -p vibe-dydx -- --mainnet
//!
//! # With custom subaccount and market filter
//! DYDX_PRIVATE_KEY="your hex private key" cargo run --bin dydx-http-private -p vibe-dydx -- \
//!   --subaccount 1 \
//!   --market BTC-USD
//! ```
