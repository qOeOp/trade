...
use vibe_model::identifiers::{AccountId, InstrumentId, TraderId};
use vibe_network::{
...
#[cfg(feature = "python")]
vibe_core::impl_pyo3_config_getters!(PolymarketUpDownEventSlugConfig {
    assets: Vec<String>,
    interval_mins: u64,
    periods: u64,
...
#[cfg(feature = "python")]
vibe_core::impl_pyo3_config_getters!(PolymarketInstrumentProviderConfig {
    load_all: bool,
...
#[cfg(feature = "python")]
vibe_core::impl_pyo3_config_getters!(PolymarketDataClientConfig {
...
#[cfg(feature = "python")]
vibe_core::impl_pyo3_config_getters!(PolymarketExecClientConfig {
    trader_id: TraderId,
