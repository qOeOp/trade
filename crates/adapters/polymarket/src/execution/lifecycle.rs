...
use vibe_core::{MUTEX_POISONED, collections::AtomicMap, time::AtomicTime};
use vibe_model::{
...
fn sync_execution_lookup_for_instrument(
    core: &vibe_live::ExecutionClientCore,
...
mod tests {
    ...
    use vibe_core::{UUID4, UnixNanos, nanos::DurationNanos};
    ...
    fn test_binary_option(raw_symbol: &str, expired: bool, neg_risk: bool) -> InstrumentAny {
        let clock = vibe_core::time::get_atomic_clock_realtime();
