...
use crate::{
    common::{
        consts::{LOT_SIZE_SCALE, POLYMARKET_VIBE_BUILDER_CODE, USDC_DECIMALS},
...
impl PolymarketOrderBuilder {
    ...
    fn build_and_sign(
        ...
        let mut poly_order = PolymarketOrder {
            ...
            builder: POLYMARKET_VIBE_BUILDER_CODE.to_string(),
...
mod tests {
    ...
    #[rstest]
    fn test_built_order_carries_vibe_builder_code() {
        let builder = make_test_builder();
        let order = builder
            .build_limit_order(
                "71321045679252212594626385532706912750332728571942532289631379312455583992563",
            ...
            .unwrap();
        assert_eq!(order.builder, POLYMARKET_VIBE_BUILDER_CODE);
    }
