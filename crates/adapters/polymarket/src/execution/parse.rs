...
/// Converts a [`PolymarketLiquiditySide`] to a Vibe [`LiquiditySide`].
...
/// Resolves the Vibe order status from Polymarket status and event type.
///
...
mod tests {
    ...
    use ustr::Ustr;
    use vibe_execution::models::fee::{FeeModel, ProbabilityPriceFeeModel};
    use vibe_model::{
        enums::OrderType,
