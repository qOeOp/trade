...
pub struct PolymarketInstrumentDef {
    /// Vibe symbol: `{conditionId}-{tokenId}`.
    pub symbol: Ustr,
...
/// Converts a Polymarket instrument definition into a Vibe `InstrumentAny`.
...
/// Converts a collection of definitions into Vibe instruments.
#[must_use]
