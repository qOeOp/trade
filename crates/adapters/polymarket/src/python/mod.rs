...
use vibe_model::{data::ensure_rust_extractor_registered, identifiers::InstrumentId};
    ...
    fn custom_data_getter_unwraps_rtds_payload_to_python_class() {
        ...
        Python::attach(|py| {
            ...
            let payload = Arc::new(PolymarketRtdsCryptoPrice::new(
                ...
                1_753_314_088_395,
                1_753_314_088_421,
                vibe_core::UnixNanos::from_millis(1_753_314_088_395),
                vibe_core::UnixNanos::from_millis(1_753_314_088_421),
            ));
