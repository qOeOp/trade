...
//! client into Vibe order events (`OrderAccepted` / `OrderFilled` / `OrderFillVoided` /
...
use ustr::Ustr;
use vibe_common::cache::fifo::{FifoCache, FifoCacheMap};
use vibe_core::{UUID4, UnixNanos, collections::AtomicMap, time::AtomicTime};
...
mod tests {
    ...
    fn test_dispatch_order_message_buffers_when_not_accepted() {
        ...
        let ctx = WsDispatchContext {
            ...
            clock: vibe_core::time::get_atomic_clock_realtime(),
            user_address: "0xtest",
