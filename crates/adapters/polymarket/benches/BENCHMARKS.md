...
setarch -R cargo bench -p vibe-polymarket --profile bench-lto \
...
Raw WS frame bytes (market channel) or REST row (user channel) -> Vibe
domain type. Covers decode + parse + cache lookup + Vibe type
