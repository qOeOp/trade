...
/// Provides a configuration for a Tardis Machine -> Vibe data -> Parquet replay run.
#[derive(Debug, Clone, Serialize, Deserialize, bon::Builder)]
#[serde(deny_unknown_fields)]
pub struct TardisReplayConfig {
    /// The Tardis Machine websocket url.
    pub tardis_ws_url: Option<String>,
    /// If symbols should be normalized with Vibe conventions.
    pub normalize_symbols: Option<bool>,
    /// The output directory for writing Vibe format Parquet files.
...
pub struct TardisDataClientConfig {
    ...
    /// The Tardis Machine WebSocket transport does not yet support proxying.
    pub proxy_url: Option<String>,
    /// Whether to normalize symbols to Vibe conventions.
...
#[cfg(feature = "python")]
vibe_core::impl_pyo3_config_getters!(TardisDataClientConfig {
