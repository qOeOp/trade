...
/// Parses a Tardis option summary message into a Vibe `OptionGreeks`.
///
...
/// Parses a Tardis option summary best bid/offer into a Vibe `QuoteTick`.
///
...
mod tests {
    use rstest::rstest;
    use vibe_model::enums::AggressorSide;
