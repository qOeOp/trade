//! Conversion functions that translate Bybit API schemas into Vibe instruments.
...
/// Converts a Bybit kline interval string to a Vibe bar aggregation and step.
///
...
/// Converts a Vibe bar aggregation and step to a Bybit kline interval.
///
...
/// Parses a spot instrument definition returned by Bybit into a Vibe currency pair.
...
/// Parses a linear contract definition (perpetual or dated future) into a Vibe instrument.
...
/// Parses an inverse contract definition into a Vibe instrument.
...
/// Parses a Bybit option contract definition into a Vibe [`CryptoOption`].
...
/// Parses a Bybit execution into a Vibe FillReport.
///
/// # Errors
///
...
/// Parses a Bybit position into a Vibe PositionStatusReport.
///
/// # Errors
///
/// This function returns an error if:
...
/// Parses a Bybit wallet balance into a Vibe account state.
///
/// # Errors
///
/// Returns an error if:
...
/// Resolves a Vibe [`OrderType`] from Bybit order classification fields.
///
...
/// and `side` (Buy/Sell). This function maps all combinations to the appropriate Vibe
...
/// Parses a Bybit order into a Vibe OrderStatusReport.
pub fn parse_order_status_report(
    ...
    // Map Bybit order status to Vibe order status
...
/// Maps Vibe time-in-force to Bybit's TIF.
///
...
mod tests {
    ...
    #[rstest]
    fn test_extract_base_coin_from_vibe_option_symbol() {
