...
use vibe_core::{
    AtomicMap, AtomicTime, consts::VIBE_USER_AGENT, env::get_or_env_var_opt, nanos::UnixNanos,
...
use crate::common::{
    consts::{BYBIT_VENUE, BYBIT_VIBE_BROKER_ID},
...
impl BybitRawHttpClient {
    ...
    fn default_headers() -> HashMap<String, String> {
        HashMap::from([
            ...
            ("X-Referer".to_string(), BYBIT_VIBE_BROKER_ID.to_string()),
        ])
    }
...
impl BybitHttpClient {
    ...
    pub async fn request_bars(
        ...
        // Convert Vibe BarSpec to Bybit interval
