...
/// Vibe-specific functionality for trading operations.
#[derive(Debug)]
#[cfg_attr(
    feature = "python",
...
impl BitmexHttpClient {
    ...
    /// Request a single instrument and parse it into a Vibe type.
    ///
    /// # Errors
    ///
    ...
    /// cannot be converted into a Vibe `Instrument`.
    ...
    /// Request all available instruments and parse them into Vibe types.
    ///
    /// # Errors
    ///
...
mod tests {
    ...
    use serde_json::json;
    use vibe_core::UUID4;
    use vibe_model::enums::OrderStatus;
