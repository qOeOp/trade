...
impl BitmexOrderType {
    /// Try to convert from Vibe OrderType with anyhow::Result.
    ///
    /// # Errors
    ///
...
impl BitmexTimeInForce {
    /// Try to convert from Vibe TimeInForce with anyhow::Result.
    ///
    /// # Errors
    ///
...
mod tests {
    ...
    fn test_time_in_force_conversions() {
        // BitMEX to Vibe (all supported variants)
        assert_eq!(
        ...
        // Vibe to BitMEX (all supported variants)
        assert_eq!(
