...
use vibe_model::enums::{AggressorSide, BookAction, OrderSide};
...
impl BitmexSide {
    /// Converts the BitMEX side into a Vibe order side.
    #[must_use]
    ...
    /// Converts the BitMEX side into a Vibe aggressor side.
    #[must_use]
