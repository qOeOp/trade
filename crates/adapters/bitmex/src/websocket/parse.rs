//! Parsers that convert BitMEX WebSocket payloads into Vibe data structures.
...
/// Converts a batch of BitMEX order-book rows into Vibe delta events.
#[must_use]
...
/// Converts BitMEX level-10 snapshots into Vibe depth events.
#[must_use]
...
/// Converts BitMEX trade messages into Vibe trade data events.
#[must_use]
...
/// Converts aggregated trade-bin messages into Vibe data events.
#[must_use]
...
/// Converts a BitMEX order book row into a Vibe order-book delta.
#[must_use]
...
/// Parse a BitMEX WebSocket order message into a Vibe `OrderStatusReport`.
///
/// # References
///
...
/// Parse a BitMEX WebSocket order update message into a Vibe `OrderUpdated` event.
///
...
/// Parse a BitMEX WebSocket execution message into a Vibe `FillReport`.
///
...
/// Parse a BitMEX WebSocket position message into a Vibe `PositionStatusReport`.
///
/// # References
///
