...
use ustr::Ustr;
use vibe_core::serialization::{
    deserialize_decimal, serialize_decimal_as_str, serialize_optional_decimal_as_str,
};
use vibe_model::orders::{Order, OrderAny};

use crate::{
    common::{
        consts::DERIVE_VIBE_REFERRAL_CODE,
        enums::{
...
pub struct DeriveOrderParams {
    ...
    pub max_fee: Decimal,
    /// User label, mapped from Vibe client order id.
    pub label: String,
    /// Vibe referral code.
...
fn build_signed_order_params(
    ...
    Ok(DeriveOrderParams {
        ...
        referral_code: DERIVE_VIBE_REFERRAL_CODE.to_string(),
...
mod tests {
    ...
    fn test_order_to_derive_payload_limit_carries_all_required_fields() {
        ...
        assert_eq!(payload["referral_code"], "vibe");
