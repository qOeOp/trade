...
//! Run with:
//! ```bash
//! cargo run -p vibe-derive --bin derive-flatten            # mainnet (default)
//! cargo run -p vibe-derive --bin derive-flatten -- testnet # testnet
//! ```
//!
...
use vibe_derive::{
    common::{
        consts::{
            ACTION_TYPEHASH, DERIVE_VIBE_REFERRAL_CODE, REST_URL_MAINNET, REST_URL_TESTNET,
