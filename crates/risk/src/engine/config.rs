...
use vibe_core::datetime::NANOSECONDS_IN_SECOND;
use vibe_model::identifiers::InstrumentId;

/// Configuration for `RiskEngineConfig` instances.
#[cfg_attr(
    feature = "python",
    pyo3::pyclass(module = "vibe_trader.risk", from_py_object)
)]
#[cfg_attr(
    feature = "python",
    pyo3_stub_gen::derive::gen_stub_pyclass(module = "vibe_trader.risk")
)]
#[cfg_attr(
    feature = "python",
    expect(
