...
mod tests {
    ...
    use rstest::*;
    use serde_json::json;
    use vibe_common::{msgbus::external_io_from_backing, testing::wait_until_async};
...
mod serial_tests {
    ...
    use rstest::*;
    #[cfg(feature = "python")]
    use vibe_common::python::msgbus::get_global_msgbus_factory_registry;
    use vibe_common::{
        enums::Environment,
    ...
    use vibe_model::data::{QuoteTick, TradeTick};
