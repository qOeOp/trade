...
//! called from the Vibe runtime itself, `block_in_place` is used
...
use vibe_core::{UUID4, UnixNanos, correctness::check_slice_not_empty};
...
impl RedisCacheDatabase {
    ...
    ///
    /// Spawns the async query on the global Vibe runtime and blocks until
