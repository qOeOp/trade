...
/// cases.
///
/// This function is primarily intended for diagnostic/logging purposes inside the VibeTrader
/// Python bindings.
...
mod tests {
    ...
    fn test_get_python_package_version_opt_missing_returns_none() {
        Python::initialize();
        assert!(get_python_package_version_opt("vibe_definitely_absent_pkg").is_none());
    }
