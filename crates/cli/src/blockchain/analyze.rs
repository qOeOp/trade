...
use vibe_infrastructure::sql::pg::get_postgres_connect_options;
use vibe_model::defi::{
  ...
  0x3333333333333333333333333333333333333333
    ...
    fn write_addresses_file(contents: &str) -> PathBuf {
        ...
        let path = std::env::temp_dir().join(format!(
            "vibe-analyze-pools-addresses-{}-{unique_id}.txt",
            std::process::id()
        ));
