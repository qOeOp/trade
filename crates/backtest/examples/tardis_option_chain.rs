...
//!
//! Run with:
//! `cargo run -p vibe-backtest --features examples,streaming --example tardis-option-chain`
...
vibe_strategy!(OptionChainBacktest);
...
fn main() -> anyhow::Result<()> {
    ...
    let greeks_data = BacktestDataConfig::builder()
        .data_type(VibeDataType::OptionGreeks)
