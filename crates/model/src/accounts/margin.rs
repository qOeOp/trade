...
use vibe_core::correctness::{CorrectnessResultExt, FAILED, check_positive_decimal};
...
impl Account for MarginAccount {
    ...
    fn purge_account_events(&mut self, ts_now: vibe_core::UnixNanos, lookback_secs: u64) {
