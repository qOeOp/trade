...
pub enum AggregationSource {
    ...
    External = 1,
    /// The data is internally aggregated (inside the Vibe system boundary).
    Internal = 2,
}
...
/// [`GreeksCalculator`](../../../vibe_common/greeks/struct.GreeksCalculator.html),
...
pub enum OrderStatus {
    ...
    Initialized = 1,
    /// The order was denied by the Vibe system, either for being invalid, unprocessable, or exceeding a risk limit.
    Denied = 2,
    /// The order became emulated by the Vibe system in the `OrderEmulator` component.
    Emulated = 3,
    /// The order was released by the Vibe system from the `OrderEmulator` component.
    Released = 4,
    /// The order was submitted by the Vibe system to the external service or trading venue (awaiting acknowledgement).
    Submitted = 5,
