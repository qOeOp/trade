...
use vibe_core::{UUID4, UnixNanos, datetime::NANOSECONDS_IN_DAY};
use vibe_model::{
...
#[repr(C)]
#[derive(Debug)]
#[cfg_attr(feature = "python", pyo3::pyclass(module = "vibe_trader.analysis"))]
#[cfg_attr(
    feature = "python",
