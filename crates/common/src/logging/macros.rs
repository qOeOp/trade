...
/// # Usage
/// ```rust
/// use vibe_common::{enums::LogColor, log_trace};
///
...
/// # Usage
/// ```rust
/// use vibe_common::{enums::LogColor, log_debug};
///
...
/// # Usage
/// ```rust
/// use vibe_common::{enums::LogColor, log_info};
///
/// let order_id = "O-19700101-000000-001-001-1";
///
/// // Automatic color (normal)
...
/// # Usage
/// ```rust
/// use vibe_common::{enums::LogColor, log_warn};
///
...
/// # Usage
/// ```rust
/// use vibe_common::{enums::LogColor, log_error};
///
...
mod tests {
    ...
    fn test_default_macro_captures_module_path() {
        ...
        //
        // The module path for this test is: vibe_common::logging::macros::tests
        // We configure a module filter and verify the log is filtered/passed accordingly.

        let config =
            LoggerConfig::from_spec("stdout=Off;fileout=Trace;vibe_common::logging::macros=Debug")
                .unwrap();
        ...
        assert!(
            log_contents.contains("vibe_common::logging::macros"),
