//! The logging framework for Vibe systems.
//!
...
use ustr::Ustr;
use vibe_core::{UUID4, time::get_atomic_clock_static};
...
///
/// If `VIBE_LOG` is set, initializes the logger with the specified config.
...
mod tests {
    ...
    fn test_ensure_logging_initialized_returns_consistent_value() {
        ...
        // - If VIBE_LOG is unset, this returns false.
        // - If VIBE_LOG is set externally, it may return true.
        //
