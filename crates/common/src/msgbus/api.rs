...
mod tests {
    ...
    use vibe_model::{data::OptionGreekValues, enums::GreeksConvention};
    use vibe_model::{
        data::{
    ...
    #[cfg(feature = "sbe")]
    use vibe_serialization::sbe::FromSbe;
    #[cfg(feature = "capnp")]
    use vibe_serialization::{capnp::FromCapnp, market_capnp};
    ...
    fn assert_publishable_json_msgpack_round_trips(encoding: SerializationEncoding) {
        ...
        assert_typed_external_round_trips(
            ...
            vibe_model::events::account::stubs::cash_account_state(),
    ...
    fn test_send_account_state_allows_reentrant_topic_access() {
        use vibe_model::{enums::AccountType, identifiers::AccountId, types::Currency};
