...
mod tests {
    ...
    fn register_with_headers_uses_extractor() {
        ...
        // values.
        let mut registry = EncoderRegistry::new();
        let causation = vibe_core::UUID4::new();
    ...
    fn register_headers_overrides_default_extractor_post_register() {
        ...
        let correlation = vibe_core::UUID4::new();
    ...
    fn register_identity_extracts_and_survives_re_register() {
        ...
        let identity = vibe_core::UUID4::new();
    ...
    fn register_identity_for_unregistered_type_is_silent_noop() {
        let mut registry = EncoderRegistry::new();
        registry.register_identity::<Sample, _>(|_| Some(vibe_core::UUID4::new()));
