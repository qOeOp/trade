...
const MARKER_HASH_DOMAIN: &[u8] = b"vibe-event-store/marker/v1";
const HIFI_HASH_DOMAIN: &[u8] = b"vibe-event-store/hifi/v1";
const DICT_HASH_DOMAIN: &[u8] = b"vibe-event-store/dict/v1";
const GAP_HASH_DOMAIN: &[u8] = b"vibe-event-store/gap/v1";
