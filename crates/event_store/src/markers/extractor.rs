...
const QUOTE_FINGERPRINT_DOMAIN: &[u8] = b"vibe-event-store/marker/fingerprint/quote/v1";
const TRADE_FINGERPRINT_DOMAIN: &[u8] = b"vibe-event-store/marker/fingerprint/trade/v1";
const BAR_FINGERPRINT_DOMAIN: &[u8] = b"vibe-event-store/marker/fingerprint/bar/v1";
const DEPTH10_FINGERPRINT_DOMAIN: &[u8] = b"vibe-event-store/marker/fingerprint/depth10/v1";
const DELTAS_FINGERPRINT_DOMAIN: &[u8] = b"vibe-event-store/marker/fingerprint/deltas/v1";
