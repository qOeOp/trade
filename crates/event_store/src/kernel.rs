...
///
/// One instance is typically owned by [`vibe_system::VibeKernel`] via the
...
mod tests {
    ...
    use vibe_core::time::get_atomic_clock_static;
    use vibe_model::{
    ...
    use vibe_system::event_store::{DataMarkerClass, DataMarkerConfig, RunIdentity};
