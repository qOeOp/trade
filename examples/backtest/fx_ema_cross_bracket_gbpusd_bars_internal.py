...
from vibe_trader.examples.strategies.ema_cross_bracket import EMACrossBracket
from vibe_trader.examples.strategies.ema_cross_bracket import EMACrossBracketConfig
