...
当前 vision 里，还值得补上一条更接近完整交易系统上层结构、但仍然足够轻的约束：

`这个投资搭子不应该把每一笔正式计划都当成彼此独立、默认可以同时执行的机会，而应该尽量站在同一份资金 / 风险预算的视角，回答“这笔机会值不值得占用组合资源，以及它要和谁竞争额度”。`
...
所以从 vision 上看，一次正式的判断或计划，至少应该尽量补上三类区分：

- 这次计划准备占用多少资金、仓位或风险预算
...
- 判断回答“现在更相信什么”
- 动作阈值回答“为什么现在值得动，或者继续不动”
- 组合预算视角回答“即使值得动，它也应该占用多少位置，以及是否值得挤掉别的机会”
